submodule (MARBL_tracers) MARBL_tracers_s
#include <MOM_memory.h>
  implicit none
contains
module procedure configure_MARBL_tracers
# include "version_variable.h"
  ...
  enddo
end procedure configure_MARBL_tracers
module procedure register_MARBL_tracers
# include "version_variable.h"
  character(len=40)  :: mdl = "MARBL_tracers" ! This module's name.
  character(len=256) :: log_message
...
end procedure register_MARBL_tracers
module procedure initialize_MARBL_tracers
...
end procedure initialize_MARBL_tracers
module procedure register_MARBL_diags
  integer :: m, diag_size
...
end procedure register_MARBL_diags
module procedure setup_saved_state
...
end procedure setup_saved_state
module procedure MARBL_tracers_column_physics
  character(len=256) :: log_message
...
end procedure MARBL_tracers_column_physics
module procedure MARBL_tracers_set_forcing
...
end procedure MARBL_tracers_set_forcing
module procedure MARBL_tracers_stock
  integer :: i, j, k, is, ie, js, je, nz, m
  is = G%isc ; ie = G%iec ; js = G%jsc ; je = G%jec ; nz = GV%ke
...
end procedure MARBL_tracers_stock
module procedure MARBL_tracers_surface_state
...
end procedure MARBL_tracers_surface_state
module procedure MARBL_tracers_get
...
end procedure MARBL_tracers_get
module procedure MARBL_tracers_end
  integer :: m
  call print_marbl_log(MARBL_instances%StatusLog)
  call MARBL_instances%StatusLog%erase()
...
end procedure MARBL_tracers_end
module procedure set_riv_flux_tracer_inds
  character(len=256) :: log_message
  character(len=48) :: name       ! A variable's name in a NetCDF file.
  integer :: m
...
end procedure set_riv_flux_tracer_inds
module procedure print_marbl_log
...
end procedure print_marbl_log
end submodule MARBL_tracers_s
