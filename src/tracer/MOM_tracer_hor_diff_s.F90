submodule (MOM_tracer_hor_diff) MOM_tracer_hor_diff_s
#include <MOM_memory.h>
  implicit none
contains
module procedure tracer_hordiff
...
end procedure tracer_hordiff
module procedure tracer_epipycnal_ML_diff
  real, dimension(SZI_(G), SZJ_(G)) :: &
...
end procedure tracer_epipycnal_ML_diff
module procedure tracer_hor_diff_init
...
end procedure tracer_hor_diff_init
module procedure tracer_hor_diff_end
  call neutral_diffusion_end(CS%neutral_diffusion_CSp)
  call hor_bnd_diffusion_end(CS%hor_bnd_diffusion_CSp)
  if (associated(CS)) deallocate(CS)

end procedure tracer_hor_diff_end
end submodule MOM_tracer_hor_diff_s
