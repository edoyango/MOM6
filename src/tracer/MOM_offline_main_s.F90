submodule (MOM_offline_main) MOM_offline_main_s
#include "MOM_memory.h"
  implicit none
contains
module procedure offline_advection_ale
...
end procedure offline_advection_ale
module procedure offline_redistribute_residual
  logical :: x_before_y
  real, dimension(SZI_(G),SZJ_(G),SZK_(GV)) :: &
...
end procedure offline_redistribute_residual
module procedure remaining_transport_sum
...
end procedure remaining_transport_sum
module procedure offline_diabatic_ale
...
end procedure offline_diabatic_ale
module procedure offline_fw_fluxes_into_ocean
  integer :: i, j, m
...
end procedure offline_fw_fluxes_into_ocean
module procedure offline_fw_fluxes_out_ocean
  integer :: m
  logical :: update_h !< Flag for whether h should be updated
...
end procedure offline_fw_fluxes_out_ocean
module procedure offline_advection_layer
...
end procedure offline_advection_layer
module procedure update_offline_fields
  integer :: stencil
  integer :: i, j, k, is, ie, js, je, nz
...
end procedure update_offline_fields
module procedure register_diags_offline_transport
...
end procedure register_diags_offline_transport
module procedure post_offline_convergence_diags
...
end procedure post_offline_convergence_diags
module procedure extract_offline_main
...
end procedure extract_offline_main
module procedure insert_offline_main
...
end procedure insert_offline_main
module procedure offline_transport_init
...
end procedure offline_transport_init
module procedure read_all_input
...
module procedure offline_transport_end
  deallocate(CS%uhtr)
  deallocate(CS%vhtr)
  deallocate(CS%eatr)
  deallocate(CS%ebtr)
...
end procedure offline_transport_end
end submodule MOM_offline_main_s
