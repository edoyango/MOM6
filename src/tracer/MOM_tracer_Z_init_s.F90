submodule (MOM_tracer_Z_init) MOM_tracer_Z_init_s
#include <MOM_memory.h>
  implicit none
contains
module procedure tracer_Z_init
...
end procedure tracer_Z_init
module procedure tracer_z_init_array
...
end procedure tracer_z_init_array
module procedure read_Z_edges
...
end procedure read_Z_edges
module procedure find_overlap
...
end procedure find_overlap
module procedure find_limited_slope
...
end procedure find_limited_slope
module procedure determine_temperature
...
end procedure determine_temperature
end submodule MOM_tracer_Z_init_s
