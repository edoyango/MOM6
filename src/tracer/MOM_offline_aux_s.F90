submodule (MOM_offline_aux) MOM_offline_aux_s
#include "MOM_memory.h"
  implicit none
contains
module procedure update_h_horizontal_flux
  ...
  do k=1,nz
    ...
    enddo ; enddo
  enddo
end procedure update_h_horizontal_flux
module procedure update_h_vertical_flux
  integer :: i, j, k, is, ie, js, je, nz
  is = G%isc ; ie = G%iec ; js = G%jsc ; je = G%jec ; nz = GV%ke
...
end procedure update_h_vertical_flux
module procedure limit_mass_flux_3d
...
end procedure limit_mass_flux_3d
module procedure distribute_residual_uh_barotropic
...
end procedure distribute_residual_uh_barotropic
module procedure distribute_residual_vh_barotropic
...
end procedure distribute_residual_vh_barotropic
module procedure distribute_residual_uh_upwards
...
end procedure distribute_residual_uh_upwards
module procedure distribute_residual_vh_upwards
...
end procedure distribute_residual_vh_upwards
module procedure offline_add_diurnal_SW
...
end procedure offline_add_diurnal_SW
module procedure update_offline_from_files
  logical :: do_ale
...
end procedure update_offline_from_files
module procedure update_offline_from_arrays
  integer :: i, j, k, is, ie, js, je, nz
...
end procedure update_offline_from_arrays
module procedure next_modulo_time
...
end procedure next_modulo_time
end submodule MOM_offline_aux_s
