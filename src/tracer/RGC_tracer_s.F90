submodule (RGC_tracer) RGC_tracer_s
#include <MOM_memory.h>
  implicit none
contains
module procedure register_RGC_tracer
...
end procedure register_RGC_tracer
module procedure initialize_RGC_tracer
...
end procedure initialize_RGC_tracer
module procedure RGC_tracer_column_physics
...
end procedure RGC_tracer_column_physics
module procedure RGC_tracer_end
  if (associated(CS)) then
    if (associated(CS%tr)) deallocate(CS%tr)
    deallocate(CS)
  endif
end procedure RGC_tracer_end
end submodule RGC_tracer_s
