submodule (MOM_tracer_advect) MOM_tracer_advect_s
#include <MOM_memory.h>
  implicit none
contains
module procedure advect_tracer
...
end procedure advect_tracer
module procedure advect_x
...
end procedure advect_x
module procedure advect_y
...
end procedure advect_y
module procedure tracer_advect_init
...
end procedure tracer_advect_init
module procedure tracer_advect_end
  if (associated(CS)) deallocate(CS)

end procedure tracer_advect_end
end submodule MOM_tracer_advect_s
