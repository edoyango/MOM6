submodule (MOM_diagnose_mld) MOM_diagnose_mld_s
#include <MOM_memory.h>
  implicit none
contains
module procedure diagnoseMLDbyDensityDifference
...
end procedure diagnoseMLDbyDensityDifference
module procedure diagnoseMLDbyEnergy
...
end procedure diagnoseMLDbyEnergy
end submodule MOM_diagnose_mld_s
