submodule (MOM_sum_output) MOM_sum_output_s
#include <MOM_memory.h>
  implicit none
contains
module procedure MOM_sum_output_init
...
end procedure MOM_sum_output_init
module procedure MOM_sum_output_end
  if (associated(CS)) then
    if (CS%do_APE_calc) then
...
end procedure MOM_sum_output_end
module procedure write_energy
...
end procedure write_energy
module procedure accumulate_net_input
  real, dimension(SZI_(G),SZJ_(G)) :: &
...
end procedure accumulate_net_input
module procedure depth_list_setup
...
end procedure depth_list_setup
module procedure create_depth_list
...
end procedure create_depth_list
module procedure write_depth_list
...
end procedure write_depth_list
module procedure read_depth_list
...
end procedure read_depth_list
module procedure get_depth_list_checksums
  ...
  deallocate(field)
end procedure get_depth_list_checksums
end submodule MOM_sum_output_s
