submodule (MOM_obsolete_params) MOM_obsolete_params_s
#include <MOM_memory.h>
  implicit none
contains
module procedure find_obsolete_params
...
end procedure find_obsolete_params
module procedure obsolete_logical
...
end procedure obsolete_logical
module procedure obsolete_char
...
end procedure obsolete_char
module procedure obsolete_real
...
end procedure obsolete_real
module procedure obsolete_int
  logical :: var_is_set  ! True if this value was read by read_param.
...
end procedure obsolete_int
end submodule MOM_obsolete_params_s
