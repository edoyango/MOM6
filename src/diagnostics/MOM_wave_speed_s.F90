submodule (MOM_wave_speed) MOM_wave_speed_s
#include <MOM_memory.h>
  implicit none
contains
module procedure wave_speed
...
end procedure wave_speed
module procedure tdma6
...
end procedure wave_speeds
module procedure tridiag_det
...
end procedure tridiag_det
module procedure wave_speed_init
...
end procedure wave_speed_init
module procedure wave_speed_set_param
...
end procedure wave_speed_set_param
end submodule MOM_wave_speed_s
