submodule (MOM_lateral_mixing_coeffs) MOM_lateral_mixing_coeffs_s
#include <MOM_memory.h>
  implicit none
contains
module procedure calc_depth_function
...
end procedure calc_depth_function
module procedure calc_resoln_function
...
end procedure calc_resoln_function
module procedure calc_sqg_struct
...
end procedure calc_sqg_struct
module procedure calc_slope_functions
  real, dimension(SZI_(G),SZJ_(G),SZK_(GV)+1)  :: e    ! The interface heights relative to mean sea level [Z ~> m]
  real, dimension(SZIB_(G),SZJ_(G),SZK_(GV)+1) :: N2_u ! Square of buoyancy frequency at u-points [L2 Z-2 T-2 ~> s-2]
  real, dimension(SZI_(G),SZJB_(G),SZK_(GV)+1) :: N2_v ! Square of buoyancy frequency at v-points [L2 Z-2 T-2 ~> s-2]
  real, dimension(SZIB_(G),SZJ_(G),SZK_(GV)+1) :: dzu  ! Z-thickness at u-points [Z ~> m]
...
end procedure calc_slope_functions
module procedure calc_Visbeck_coeffs_old
...
end procedure calc_Visbeck_coeffs_old
module procedure calc_Eady_growth_rate_2D
...
end procedure calc_Eady_growth_rate_2D
module procedure calc_slope_functions_using_just_e
...
end procedure calc_slope_functions_using_just_e
module procedure calc_QG_slopes
  real, dimension(SZI_(G),SZJ_(G),SZK_(GV)+1)  :: e    ! The interface heights relative to mean sea level [Z ~> m]
...
end procedure calc_QG_slopes
module procedure calc_QG_Leith_viscosity
...
end procedure calc_QG_Leith_viscosity
module procedure VarMix_init
...
end procedure VarMix_init
module procedure VarMix_end
...
end procedure VarMix_end
end submodule MOM_lateral_mixing_coeffs_s
