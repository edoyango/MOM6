...
#include <MOM_memory.h>
  implicit none
contains
module procedure thickness_diffuse
...
end procedure thickness_diffuse
module procedure thickness_diffuse_full
  real, dimension(SZI_(G),SZJ_(G),SZK_(GV)) :: &
...
end procedure thickness_diffuse_full
module procedure streamfn_solver
...
end procedure streamfn_solver
module procedure add_interface_Kh
  integer :: i, j, k, is, ie, js, je, nz
  is = G%isc ; ie = G%iec ; js = G%jsc ; je = G%jec ; nz = GV%ke
...
end procedure add_interface_Kh
module procedure add_detangling_Kh
  real, dimension(SZI_(G),SZJ_(G),SZK_(GV)) :: &
...
end procedure add_detangling_Kh
module procedure thickness_diffuse_init
...
end procedure thickness_diffuse_init
module procedure thickness_diffuse_get_KH
  integer :: i,j,k
...
end procedure thickness_diffuse_get_KH
module procedure thickness_diffuse_end
...
end procedure thickness_diffuse_end
