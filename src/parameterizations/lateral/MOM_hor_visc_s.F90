submodule (MOM_hor_visc) MOM_hor_visc_s
#include <MOM_memory.h>
  implicit none
contains
module procedure horizontal_viscosity
...
end procedure horizontal_viscosity
module procedure hor_visc_init
...
end procedure hor_visc_init
module procedure hor_visc_vel_stencil
  stencil = 2

  if ((CS%Leith_Kh) .or. (CS%Leith_Ah) .or. (CS%use_Leithy)) then
    stencil = 3
  endif
end procedure hor_visc_vel_stencil
module procedure align_aniso_tensor_to_grid
...
end procedure align_aniso_tensor_to_grid
module procedure smooth_GME
  ...
  enddo ! s-loop
end procedure smooth_GME
module procedure smooth_x9_h
...
end procedure hor_visc_end
end submodule MOM_hor_visc_s
