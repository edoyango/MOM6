submodule (MOM_meso_sfn_ANN) MOM_meso_sfn_ANN_s
#include <MOM_memory.h>
  implicit none
contains
module procedure meso_sfn_ANN_compute
  ...
  deallocate(x, y, yy)
end procedure meso_sfn_ANN_compute
module procedure center_grad_rho
...
end procedure center_grad_rho
module procedure center2uv
...
end procedure center2uv
module procedure vel_gradients
  ...
  do k=1, nz
    ...
    enddo; enddo
  enddo
end procedure vel_gradients
module procedure calc_layered_density_gradients
...
end procedure calc_layered_density_gradients
module procedure meso_sfn_ANN_init
...
# include "version_variable.h"
  ...
  CS%initialized = .true.
end procedure meso_sfn_ANN_init
module procedure meso_sfn_ANN_end
  call ANN_end(CS%ann_rho_flux)

end procedure meso_sfn_ANN_end
end submodule MOM_meso_sfn_ANN_s
