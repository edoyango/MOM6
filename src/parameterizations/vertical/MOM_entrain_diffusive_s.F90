submodule (MOM_entrain_diffusive) MOM_entrain_diffusive_s
#include <MOM_memory.h>
  implicit none
contains
module procedure entrainment_diffusive
...
end procedure entrainment_diffusive
module procedure F_to_ent
...
end procedure F_to_ent
module procedure set_Ent_bl
  real, dimension(SZI_(G)) :: &
...
end procedure set_Ent_bl
module procedure determine_dSkb
  real, dimension(SZI_(G),SZK_(GV)) :: &
...
end procedure determine_dSkb
module procedure F_kb_to_ea_kb
...
end procedure F_kb_to_ea_kb
module procedure determine_Ea_kb
  real, dimension(SZI_(G)) :: &
...
end procedure determine_Ea_kb
module procedure find_maxF_kb
  real, dimension(SZI_(G)) :: &
...
end procedure find_maxF_kb
module procedure entrain_diffusive_init
...
end procedure entrain_diffusive_init
end submodule MOM_entrain_diffusive_s
