submodule (MOM_ALE_sponge) MOM_ALE_sponge_s
...
end procedure initialize_ALE_sponge_fixed
module procedure get_ALE_sponge_nz_data
  get_ALE_sponge_nz_data = CS%nz_data
end procedure get_ALE_sponge_nz_data
module procedure get_ALE_sponge_thicknesses
...
end procedure get_ALE_sponge_thicknesses
...
end procedure initialize_ALE_sponge_varying
module procedure init_ALE_sponge_diags
...
end procedure init_ALE_sponge_diags
...
end procedure set_up_ALE_sponge_field_fixed
...
end procedure set_up_ALE_sponge_field_varying
...
end procedure set_up_ALE_sponge_vel_field_fixed
...
end procedure set_up_ALE_sponge_vel_field_varying
module procedure apply_ALE_sponge
...
end procedure apply_ALE_sponge
module procedure rotate_ALE_sponge
...
end procedure rotate_ALE_sponge
module procedure update_ALE_sponge_field
  integer :: n
  do n=1,sponge%fldno
    if (associated(sponge%var(n)%p, p_old)) sponge%var(n)%p => p_new
  enddo
end procedure update_ALE_sponge_field
module procedure ALE_sponge_end
  integer :: m
  if (.not.associated(CS)) return
...
end procedure ALE_sponge_end
end submodule MOM_ALE_sponge_s
