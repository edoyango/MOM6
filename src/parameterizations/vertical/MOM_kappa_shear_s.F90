submodule (MOM_kappa_shear) MOM_kappa_shear_s
#include <MOM_memory.h>
  implicit none
contains
module procedure Calculate_kappa_shear
...
end procedure Calculate_kappa_shear
module procedure Calc_kappa_shear_vertex
...
end procedure Calc_kappa_shear_vertex
module procedure kappa_shear_column
  real, dimension(nzc) :: &
...
end procedure kappa_shear_column
module procedure calculate_projected_state
...
end procedure calculate_projected_state
module procedure find_kappa_tke
  real, dimension(nz) :: &
...
end procedure find_kappa_tke
module procedure kappa_shear_init
...
end procedure kappa_shear_init
module procedure kappa_shear_is_used
  character(len=40)  :: mdl = "MOM_kappa_shear"  ! This module's name.
  call get_param(param_file, mdl, "USE_JACKSON_PARAM", kappa_shear_is_used, &
                 default=.false., do_not_log=.true.)
end procedure kappa_shear_is_used
module procedure kappa_shear_at_vertex
  character(len=40)  :: mdl = "MOM_kappa_shear"  ! This module's name.
...
end procedure kappa_shear_at_vertex
end submodule MOM_kappa_shear_s
