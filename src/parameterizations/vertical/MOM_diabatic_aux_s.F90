submodule (MOM_diabatic_aux) MOM_diabatic_aux_s
#include <MOM_memory.h>
  implicit none
contains
module procedure make_frazil
...
end procedure make_frazil
module procedure differential_diffuse_T_S
  real, dimension(SZI_(G)) :: &
  ...
  do j=js,je
    ...
    enddo ; enddo
  enddo
end procedure differential_diffuse_T_S
module procedure adjust_salt
...
end procedure adjust_salt
module procedure triDiagTS
  ...
  do j=js,je
    ...
    enddo ; enddo
  enddo
end procedure triDiagTS
module procedure triDiagTS_Eulerian
  real :: b1(SZIB_(G))          ! A variable used by the tridiagonal solver [H-1 ~> m-1 or m2 kg-1].
  real :: d1(SZIB_(G))          ! A variable used by the tridiagonal solver [nondim].
  real :: c1(SZIB_(G),SZK_(GV)) ! A variable used by the tridiagonal solver [nondim].
  real :: h_tr, b_denom_1       ! Two temporary thicknesses [H ~> m or kg m-2].
  ...
  do j=js,je
    ...
    enddo ; enddo
  enddo
end procedure triDiagTS_Eulerian
module procedure find_uv_at_h
...
end procedure find_uv_at_h
module procedure set_pen_shortwave
...
end procedure set_pen_shortwave
module procedure applyBoundaryFluxesInOut
...
end procedure applyBoundaryFluxesInOut
module procedure diabatic_aux_init
...
end procedure diabatic_aux_init
module procedure diabatic_aux_end
...
end procedure diabatic_aux_end
end submodule MOM_diabatic_aux_s
