submodule (MOM_regularize_layers) MOM_regularize_layers_s
#include <MOM_memory.h>
  implicit none
contains
module procedure regularize_layers
...
end procedure regularize_layers
module procedure regularize_surface
...
end procedure regularize_surface
module procedure find_deficit_ratios
  real, dimension(SZIB_(G),SZJ_(G)) :: &
...
end procedure find_deficit_ratios
module procedure regularize_layers_init
...
end procedure regularize_layers_init
end submodule MOM_regularize_layers_s
