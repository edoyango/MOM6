submodule (MOM_geothermal) MOM_geothermal_s
#include <MOM_memory.h>
  implicit none
contains
module procedure geothermal_entraining
...
end procedure geothermal_entraining
module procedure geothermal_in_place
  real, dimension(SZI_(G)) :: &
    heat_rem,  & ! remaining heat [H C ~> m degC or kg degC m-2]
    h_geo_rem, & ! remaining thickness to apply geothermal heating [H ~> m or kg m-2]
...
end procedure geothermal_in_place
module procedure geothermal_init
...
end procedure geothermal_init
module procedure geothermal_end
  if (allocated(CS%geo_heat)) deallocate(CS%geo_heat)
end procedure geothermal_end
end submodule MOM_geothermal_s
