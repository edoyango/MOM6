submodule (MOM_CVMix_conv) MOM_CVMix_conv_s
#include <MOM_memory.h>
  implicit none
contains
module procedure CVMix_conv_init
...
end procedure CVMix_conv_init
module procedure calculate_CVMix_conv
...
end procedure calculate_CVMix_conv
module procedure CVMix_conv_is_used
  call get_param(param_file, mdl, "USE_CVMix_CONVECTION", CVMix_conv_is_used, &
                 default=.false., do_not_log=.true.)

end procedure CVMix_conv_is_used
end submodule MOM_CVMix_conv_s
