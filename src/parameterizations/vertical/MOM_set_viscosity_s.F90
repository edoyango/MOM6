submodule (MOM_set_visc) MOM_set_visc_s
#include <MOM_memory.h>
  implicit none
contains
module procedure set_viscous_BBL
...
end procedure set_viscous_BBL
module procedure find_L_open_uniform_slope
...
end procedure find_L_open_uniform_slope
module procedure find_L_open_concave_trigonometric
  real :: crv              ! crv is the curvature of the bottom depth across a
...
end procedure find_L_open_concave_trigonometric
module procedure find_L_open_concave_iterative
  real :: crv              ! crv is the curvature of the bottom depth across a
  real :: crv_3            ! crv/3 [Z ~> m].
  real :: slope            ! The absolute value of the bottom depth slope across
  real :: Vol_open         ! The cell volume above which the face is fully is open [Z ~> m].
...
end procedure find_L_open_concave_iterative
module procedure test_L_open_concave
  real :: crv              ! crv is the curvature of the bottom depth across a
  real :: crv_3            ! crv/3 [Z ~> m].
  real :: slope            ! The absolute value of the bottom depth slope across
  real :: Vol_open         ! The cell volume above which the face is fully is open [Z ~> m].
...
end procedure test_L_open_concave
module procedure find_L_open_convex
  real :: crv              ! crv is the curvature of the bottom depth across a
  real :: crv_3            ! crv/3 [Z ~> m].
  real :: slope            ! The absolute value of the bottom depth slope across
...
end procedure find_L_open_convex
module procedure set_v_at_u
...
end procedure set_v_at_u
module procedure set_u_at_v
...
end procedure set_u_at_v
module procedure set_viscous_ML
  real, dimension(SZIB_(G)) :: &
...
end procedure set_viscous_ML
module procedure set_visc_register_restarts
...
end procedure set_visc_register_restarts
module procedure remap_vertvisc_aux_vars
...
end procedure remap_vertvisc_aux_vars
module procedure set_visc_init
...
end procedure set_visc_init
module procedure set_visc_end
...
end procedure set_visc_end
end submodule MOM_set_visc_s
