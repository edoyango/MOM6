submodule (MOM_bkgnd_mixing) MOM_bkgnd_mixing_s
#include <MOM_memory.h>
  implicit none
contains
module procedure bkgnd_mixing_init
...
end procedure bkgnd_mixing_init
module procedure calculate_bkgnd_mixing
...
end procedure calculate_bkgnd_mixing
module procedure CVMix_bkgnd_is_used
  call get_param(param_file, mdl, "USE_CVMix_BACKGROUND", CVMix_bkgnd_is_used, &
                 default=.false., do_not_log=.true.)

end procedure CVMix_bkgnd_is_used
module procedure check_bkgnd_scheme
...
end procedure check_bkgnd_scheme
module procedure bkgnd_mixing_end
  if (.not. associated(CS)) return
  deallocate(CS)

end procedure bkgnd_mixing_end
end submodule MOM_bkgnd_mixing_s
