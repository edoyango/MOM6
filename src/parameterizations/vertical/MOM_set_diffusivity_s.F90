submodule (MOM_set_diffusivity) MOM_set_diffusivity_s
...
module procedure find_TKE_to_Kd
  real, dimension(SZI_(G),SZK_(GV)) :: &
...
end procedure find_TKE_to_Kd
module procedure find_N2
  real, dimension(SZI_(G),SZK_(GV)+1) :: &
...
end procedure find_N2
module procedure double_diffusion
  real, dimension(SZI_(G)) :: &
...
end procedure double_diffusion
module procedure add_drag_diffusivity
...
end procedure add_drag_diffusivity
module procedure add_LOTW_BBL_diffusivity
...
end procedure add_LOTW_BBL_diffusivity
module procedure add_MLrad_diffusivity
...
end procedure add_MLrad_diffusivity
module procedure set_BBL_TKE
  real, dimension(SZI_(G)) :: &
...
end procedure set_BBL_TKE
module procedure set_density_ratios
...
end procedure set_density_ratios
module procedure set_diffusivity_init
...
end procedure set_diffusivity_init
module procedure set_diffusivity_end
...
end procedure set_diffusivity_end
end submodule MOM_set_diffusivity_s
