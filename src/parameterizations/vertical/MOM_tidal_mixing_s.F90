submodule (MOM_tidal_mixing) MOM_tidal_mixing_s
#include <MOM_memory.h>
  implicit none
contains
module procedure tidal_mixing_init
...
end procedure tidal_mixing_init
module procedure calculate_tidal_mixing
...
end procedure calculate_tidal_mixing
module procedure calculate_CVMix_tidal
...
end procedure calculate_CVMix_tidal
module procedure add_int_tide_diffusivity
...
end procedure add_int_tide_diffusivity
module procedure setup_tidal_diagnostics
...
end procedure setup_tidal_diagnostics
module procedure post_tidal_diagnostics
  if (CS%Int_tide_dissipation .or. CS%Lee_wave_dissipation .or. CS%Lowmode_itidal_dissipation) then
...
end procedure post_tidal_diagnostics
module procedure tidal_mixing_h_amp
  integer :: i
  h_amp(:) = 0.0
...
end procedure tidal_mixing_h_amp
module procedure read_tidal_energy
...
end procedure read_tidal_energy
module procedure read_tidal_constituents
...
end procedure read_tidal_constituents
module procedure tidal_mixing_end
...
end procedure tidal_mixing_end
end submodule MOM_tidal_mixing_s
