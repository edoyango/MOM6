submodule (MOM_bulk_mixed_layer) MOM_bulk_mixed_layer_s
#include <MOM_memory.h>
  implicit none
contains
module procedure bulkmixedlayer
...
module procedure mixedlayer_convection
  real, dimension(SZI_(G)) :: &
...
end procedure mixedlayer_convection
module procedure find_starting_TKE
...
end procedure find_starting_TKE
module procedure mechanical_entrainment
...
end procedure mechanical_entrainment
module procedure sort_ML
...
end procedure sort_ML
module procedure resort_ML
...
end procedure resort_ML
module procedure mixedlayer_detrain_2
...
end procedure mixedlayer_detrain_2
module procedure mixedlayer_detrain_1
  real :: Ih                  ! The inverse of a thickness [H-1 ~> m-1 or m2 kg-1].
...
end procedure mixedlayer_detrain_1
module procedure bulkmixedlayer_init
...
end procedure bulkmixedlayer_init
module procedure EF4
...
end submodule MOM_bulk_mixed_layer_s
