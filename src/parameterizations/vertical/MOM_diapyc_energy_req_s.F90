submodule (MOM_diapyc_energy_req) MOM_diapyc_energy_req_s
  implicit none
contains
module procedure diapyc_energy_req_test
...
end procedure diapyc_energy_req_test
module procedure diapyc_energy_req_calc
  real, dimension(GV%ke) :: &
...
end procedure diapyc_energy_req_calc
...
module procedure diapyc_energy_req_init
...
end procedure diapyc_energy_req_init
module procedure diapyc_energy_req_end
  if (associated(CS)) deallocate(CS)
end procedure diapyc_energy_req_end
end submodule MOM_diapyc_energy_req_s
