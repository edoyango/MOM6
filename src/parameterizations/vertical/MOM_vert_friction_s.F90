submodule (MOM_vert_friction) MOM_vert_friction_s
#include <MOM_memory.h>
  implicit none
contains
module procedure vertFPmix
...
end procedure vertFPmix
module procedure find_coupling_coef_gl90
  ...
  enddo
end procedure find_coupling_coef_gl90
module procedure vertvisc
  real :: b1
  real :: c1(SZK_(GV))
  real :: d1
  real :: Ray
...
end procedure vertvisc
module procedure vertvisc_remnant
  real :: b1
  real :: c1(SZK_(GV))
  real :: d1
  real :: Ray
...
end procedure vertvisc_remnant
module procedure vertvisc_coef
...
end procedure vertvisc_coef
module procedure find_coupling_coef
  real :: &
...
end procedure find_coupling_coef
module procedure vertvisc_limit_vel
...
end procedure vertvisc_limit_vel
module procedure vertvisc_init
...
end procedure vertvisc_init
module procedure updateCFLtruncationValue
...
end procedure updateCFLtruncationValue
module procedure vertvisc_end
  if ((len_trim(CS%u_trunc_file) > 0) .or. (len_trim(CS%v_trunc_file) > 0)) &
...
end procedure vertvisc_end
end submodule MOM_vert_friction_s
