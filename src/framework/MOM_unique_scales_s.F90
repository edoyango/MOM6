submodule (MOM_unique_scales) MOM_unique_scales_s
  implicit none
contains
module procedure check_scaling_uniqueness
...
end procedure check_scaling_uniqueness
module procedure encode_dim_powers
...
end procedure encode_dim_powers
module procedure scales_to_powers
...
end procedure scales_to_powers
module procedure non_unique_scales
...
end procedure non_unique_scales
module procedure int_array_msg
  ...
  enddo
end procedure int_array_msg
end submodule MOM_unique_scales_s
