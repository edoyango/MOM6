submodule (MOM_domains) MOM_domains_s
  implicit none
contains
module procedure MOM_domains_init
...
end procedure MOM_domains_init
module procedure MOM_define_layout
  ...
  layout = (/ idiv, jdiv /)
end procedure MOM_define_layout
module procedure gen_auto_mask_table
...
end procedure gen_auto_mask_table
module procedure determine_land_blocks
...
end procedure determine_land_blocks
module procedure write_auto_mask_file
...
end procedure write_auto_mask_file
end submodule MOM_domains_s
