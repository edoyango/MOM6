submodule (MOM_file_parser_tests) MOM_file_parser_tests_s
  implicit none
contains
module procedure test_open_param_file
...
end procedure test_open_param_file
module procedure test_close_param_file_quiet
  type(param_file_type) :: param
  call create_test_file(param_filename)

  call open_param_file(param_filename, param)
  call close_param_file(param, quiet_close=.true.)
end procedure test_close_param_file_quiet
module procedure test_open_param_file_component
  type(param_file_type) :: param
  integer :: i
  call create_test_file(param_filename)
...
end procedure test_open_param_file_component
module procedure cleanup_open_param_file_component
  integer :: i
  call delete_test_file(param_filename)
  do i = 1, 4
    call delete_test_file("TEST_parameter_doc."//param_docfiles(i))
  enddo
end procedure cleanup_open_param_file_component
module procedure test_open_param_file_docdir
  type(param_file_type) :: param
  call create_test_file(param_filename)

  call open_param_file(param_filename, param, doc_file_dir='./')
  call close_param_file(param)
end procedure test_open_param_file_docdir
module procedure test_open_param_file_empty_filename
  type(param_file_type) :: param
  call open_param_file('', param)
  ! FATAL; return to program
end procedure test_open_param_file_empty_filename
module procedure test_open_param_file_long_name
  type(param_file_type) :: param
  ...
  call close_param_file(param)
end procedure test_open_param_file_long_name
module procedure test_missing_param_file
  type(param_file_type) :: param
  logical :: file_exists
  ...
  ! FATAL; return to program
end procedure test_missing_param_file
module procedure test_open_param_file_ioerr
  type(param_file_type) :: param
  call create_test_file(param_filename, mode=int(o'000'))

  call open_param_file(param_filename, param)
  ! FATAL; return to program
end procedure test_open_param_file_ioerr
module procedure cleanup_open_param_file_ioerr
  integer :: rc
  rc = chmod(param_filename, int(o'700'))
  call cleanup_file_parser()
end procedure cleanup_open_param_file_ioerr
module procedure test_open_param_file_netcdf
  type(param_file_type) :: param
  call create_test_file(netcdf_param_filename)

  call open_param_file(netcdf_param_filename, param)
  ! FATAL; return to program
end procedure test_open_param_file_netcdf
module procedure cleanup_open_param_file_netcdf
  integer :: param_unit
  logical :: is_open
  call delete_test_file(netcdf_param_filename)
end procedure cleanup_open_param_file_netcdf
module procedure test_open_param_file_checkable
  type(param_file_type) :: param
  call create_test_file(param_filename)

  call open_param_file(param_filename, param, checkable=.false.)
  call close_param_file(param)
end procedure test_open_param_file_checkable
module procedure test_reopen_param_file
  type(param_file_type) :: param
  call create_test_file(param_filename)
  ...
  call open_param_file(param_filename, param)
  call close_param_file(param)
end procedure test_reopen_param_file
module procedure test_open_param_file_no_doc
  type(param_file_type) :: param
  type(string) :: lines(1)
  ...
  call open_param_file(param_filename, param)
  call close_param_file(param)
end procedure test_open_param_file_no_doc
module procedure test_read_param_int
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(1)
...
end procedure test_read_param_int
module procedure test_read_param_int_missing
  type(param_file_type) :: param
  integer :: sample
  call create_test_file(param_filename)
  ...
  ! FATAL; return to program
end procedure test_read_param_int_missing
module procedure test_read_param_int_undefined
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(1)
  ...
  ! FATAL; return to program
end procedure test_read_param_int_undefined
module procedure test_read_param_int_type_err
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(1)
  ...
  call read_param(param, sample_param_name, sample)
  ! FATAL; return to program
end procedure test_read_param_int_type_err
module procedure test_read_param_int_array
  type(param_file_type) :: param
  integer :: sample(3)
  type(string) :: lines(1)
...
end procedure test_read_param_int_array
module procedure test_read_param_int_array_missing
  type(param_file_type) :: param
  integer :: sample(3)
  call create_test_file(param_filename)
  ...
  call read_param(param, missing_param_name, sample, fail_if_missing=.true.)
  ! FATAL; return to program
end procedure test_read_param_int_array_missing
module procedure test_read_param_int_array_undefined
  type(param_file_type) :: param
  integer :: sample(3)
  type(string) :: lines(1)
  lines = string('#undef ' // sample_param_name)
  ...
  call read_param(param, sample_param_name, sample, fail_if_missing=.true.)
  ! FATAL; return to program
end procedure test_read_param_int_array_undefined
module procedure test_read_param_int_array_type_err
  type(param_file_type) :: param
  integer :: sample(3)
  type(string) :: lines(1)
  ...
  call read_param(param, sample_param_name, sample)
  ! FATAL; return to program
end procedure test_read_param_int_array_type_err
module procedure test_read_param_real
  type(param_file_type) :: param
  real :: sample
  type(string) :: lines(1)
  ...
  call assert(sample == sample_result, 'Incorrect value')
end procedure test_read_param_real
module procedure test_read_param_real_missing
  type(param_file_type) :: param
  real :: sample
  call create_test_file(param_filename)
  ...
  call read_param(param, missing_param_name, sample, fail_if_missing=.true.)
  ! FATAL; return to program
end procedure test_read_param_real_missing
module procedure test_read_param_real_undefined
  type(param_file_type) :: param
  real :: sample
  type(string) :: lines(1)
  lines = string('#undef ' // sample_param_name)
  ...
  call read_param(param, sample_param_name, sample, fail_if_missing=.true.)
  ! FATAL; return to program
end procedure test_read_param_real_undefined
module procedure test_read_param_real_type_err
  type(param_file_type) :: param
  real :: sample
  type(string) :: lines(1)
  ...
  call read_param(param, sample_param_name, sample)
  ! FATAL; return to program
end procedure test_read_param_real_type_err
module procedure test_read_param_real_array
  type(param_file_type) :: param
  real :: sample(3)
  type(string) :: lines(1)
  character(len=*), parameter :: sample_input = '1., 2., 3.'
  ...
  call assert(all(sample == sample_result), 'Incorrect value')
end procedure test_read_param_real_array
module procedure test_read_param_real_array_missing
  type(param_file_type) :: param
  real :: sample(3)
  call create_test_file(param_filename)
  ...
  call read_param(param, missing_param_name, sample, fail_if_missing=.true.)
  ! FATAL; return to program
end procedure test_read_param_real_array_missing
module procedure test_read_param_real_array_undefined
  type(param_file_type) :: param
  real :: sample(3)
  type(string) :: lines(1)
  lines = string('#undef ' // sample_param_name)
  ...
  call read_param(param, sample_param_name, sample, fail_if_missing=.true.)
  ! FATAL; return to program
end procedure test_read_param_real_array_undefined
module procedure test_read_param_real_array_type_err
  type(param_file_type) :: param
  real :: sample(3)
  type(string) :: lines(1)
  ...
  call read_param(param, sample_param_name, sample)
  ! FATAL; return to program
end procedure test_read_param_real_array_type_err
module procedure test_read_param_logical
  type(param_file_type) :: param
  logical :: sample
  type(string) :: lines(1)
...
end procedure test_read_param_logical
module procedure test_read_param_logical_missing
  type(param_file_type) :: param
  logical :: sample
  call create_test_file(param_filename)
  ...
  call read_param(param, missing_param_name, sample, fail_if_missing=.true.)
  ! FATAL; return to program
end procedure test_read_param_logical_missing
module procedure test_read_param_char_no_delim
  type(param_file_type) :: param
  ...
  call assert(sample == sample_result, 'Incorrect value')
end procedure test_read_param_char_no_delim
module procedure test_read_param_char_quote_delim
  type(param_file_type) :: param
  character(len=8) :: sample
  type(string) :: lines(1)
  character(len=*), parameter :: sample_input = '"abcdefgh"'
  ...
  call assert(sample == sample_result, 'Incorrect value')
end procedure test_read_param_char_quote_delim
module procedure test_read_param_char_apostrophe_delim
  type(param_file_type) :: param
  character(len=8) :: sample
  type(string) :: lines(1)
  character(len=*), parameter :: sample_input = "'abcdefgh'"
  ...
  call assert(sample == sample_result, 'Incorrect value')
end procedure test_read_param_char_apostrophe_delim
module procedure test_read_param_char_missing
  type(param_file_type) :: param
  character(len=8) :: sample
  call create_test_file(param_filename)
  ...
  call read_param(param, missing_param_name, sample, fail_if_missing=.true.)
  ! FATAL; return to program
end procedure test_read_param_char_missing
module procedure test_read_param_char_array
  type(param_file_type) :: param
  ...
  call assert(all(sample == sample_result), 'Incorrect value')
end procedure test_read_param_char_array
module procedure test_read_param_char_array_missing
  type(param_file_type) :: param
  ...
  call read_param(param, missing_param_name, sample, fail_if_missing=.true.)
  ! FATAL; return to program
end procedure test_read_param_char_array_missing
module procedure test_read_param_time_date
  type(param_file_type) :: param
  ...
  call read_param(param, sample_param_name, sample)
  call close_param_file(param)
end procedure test_read_param_time_date
module procedure test_read_param_time_date_bad_format
  type(param_file_type) :: param
  type(time_type) :: sample
  type(string) :: lines(1)
  lines = string(sample_param_name // ' = 1980--01--01 00::00::00')
  ...
  call read_param(param, sample_param_name, sample)
  ! FATAL; return to program
end procedure test_read_param_time_date_bad_format
module procedure test_read_param_time_tuple
  type(param_file_type) :: param
  type(time_type) :: sample
  type(string) :: lines(1)
  ...
  call read_param(param, sample_param_name, sample)
  call close_param_file(param)
end procedure test_read_param_time_tuple
module procedure test_read_param_time_bad_tuple
  type(param_file_type) :: param
  type(time_type) :: sample
  type(string) :: lines(1)
  ...
  call read_param(param, sample_param_name, sample)
  ! FATAL; return to program
end procedure test_read_param_time_bad_tuple
module procedure test_read_param_time_bad_tuple_values
  type(param_file_type) :: param
  type(time_type) :: sample
  type(string) :: lines(1)
  ...
  call read_param(param, sample_param_name, sample)
  ! FATAL; return to program
end procedure test_read_param_time_bad_tuple_values
module procedure test_read_param_time_unit
  type(param_file_type) :: param
  type(time_type) :: sample
  type(string) :: lines(1)
  ...
  call close_param_file(param)
end procedure test_read_param_time_unit
module procedure test_read_param_time_missing
  type(param_file_type) :: param
  type(time_type) :: sample
  call create_test_file(param_filename)
  ...
  call read_param(param, missing_param_name, sample, fail_if_missing=.true.)
  ! FATAL; return to program
end procedure test_read_param_time_missing
module procedure test_read_param_time_undefined
  type(param_file_type) :: param
  type(time_type) :: sample
  type(string) :: lines(1)
  lines = string('#undef ' // sample_param_name)
  ...
  call read_param(param, sample_param_name, sample, fail_if_missing=.true.)
  ! FATAL; return to program
end procedure test_read_param_time_undefined
module procedure test_read_param_time_type_err
  type(param_file_type) :: param
  type(time_type) :: sample
  type(string) :: lines(1)
  ...
  call read_param(param, sample_param_name, sample)
  ! FATAL; return to program
end procedure test_read_param_time_type_err
module procedure test_read_param_unused_fatal
  type(param_file_type) :: param
  type(string) :: lines(2)
  lines = [ &
  ...
  call close_param_file(param)
  ! FATAL; return to program
end procedure test_read_param_unused_fatal
module procedure test_read_param_replace_tabs
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(1)
  ...
  call assert(sample == sample_result, 'Incorrect value')
end procedure test_read_param_replace_tabs
module procedure test_read_param_pad_equals
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(1)
  character(len=*), parameter :: sample_input = "1"
  ...
  call assert(sample == sample_result, 'Incorrect value')
end procedure test_read_param_pad_equals
module procedure test_read_param_multiline_param
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(2)
  integer, parameter :: sample_result = 1
...
end procedure test_read_param_multiline_param
module procedure test_read_param_multiline_param_unclosed
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(1)
  character, parameter :: backslash = achar(92)
  ...
  call open_param_file(param_filename, param)
  ! FATAL; return to program
end procedure test_read_param_multiline_param_unclosed
module procedure test_read_param_multiline_comment
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(6)
  lines = [ &
  ...
  call open_param_file(param_filename, param)
  call close_param_file(param)
end procedure test_read_param_multiline_comment
module procedure test_read_param_multiline_comment_unclosed
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(1)
  ...
  call open_param_file(param_filename, param)
  ! FATAL; return to program
end procedure test_read_param_multiline_comment_unclosed
module procedure test_read_param_misplaced_quote
  type(param_file_type) :: param
  ...
  call open_param_file(param_filename, param)
  ! FATAL; return to program
end procedure test_read_param_misplaced_quote
module procedure test_read_param_define
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(1)
  ...
  call assert(sample == sample_result, 'Incorrect value')
end procedure test_read_param_define
module procedure test_read_param_define_as_flag
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(1)
  ...
  call read_param(param, sample_param_name, sample)
  call close_param_file(param)
end procedure test_read_param_define_as_flag
module procedure test_read_param_override
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(2)
  integer, parameter :: sample_result = 2
  ...
  call assert(sample == sample_result, 'Incorrect value')
end procedure test_read_param_override
module procedure test_read_param_override_misplaced
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(1)
  ...
  call open_param_file(param_filename, param)
  ! FATAL; return to program
end procedure test_read_param_override_misplaced
module procedure test_read_param_override_twice
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(3)
  lines = [ &
  ...
  call read_param(param, sample_param_name, sample)
  ! FATAL; return to program
end procedure test_read_param_override_twice
module procedure test_read_param_override_repeat
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(3)
  lines = [ &
  ...
  call read_param(param, sample_param_name, sample)
  ! FATAL; return to program
end procedure test_read_param_override_repeat
module procedure test_read_param_override_warn_chain
  type(param_file_type) :: param
  integer :: sample
  ...
  call read_param(param, other_param_name, sample)
  call close_param_file(param)
end procedure test_read_param_override_warn_chain
module procedure test_read_param_assign_after_override
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(2)
  lines = [ &
  ...
  call read_param(param, sample_param_name, sample)
  call close_param_file(param)
end procedure test_read_param_assign_after_override
module procedure test_read_param_override_no_def
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(1)
  ...
  call read_param(param, sample_param_name, sample)
  ! FATAL; return to program
end procedure test_read_param_override_no_def
module procedure test_read_param_assign_twice
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(2)
  lines = [ &
  ...
  call read_param(param, sample_param_name, sample)
  ! FATAL; return to program
end procedure test_read_param_assign_twice
module procedure test_read_param_assign_repeat
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(2)
  lines = [ &
  ...
  call read_param(param, sample_param_name, sample)
  call close_param_file(param)
end procedure test_read_param_assign_repeat
module procedure test_read_param_null_stmt
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(1)
  ...
  call read_param(param, sample_param_name, sample)
  ! FATAL; return to program
end procedure test_read_param_null_stmt
module procedure test_read_param_assign_in_define
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(1)
  ...
  call read_param(param, sample_param_name, sample)
  ! FATAL; return to program
end procedure test_read_param_assign_in_define
module procedure test_read_param_block
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(3)
  integer, parameter :: sample_result = 123
  ...
  call assert(sample == sample_result, 'Incorrect value')
end procedure test_read_param_block
module procedure test_read_param_block_stack
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(5)
  lines = [ &
  ...
  call clearParameterBlock(param)
  call close_param_file(param)
end procedure test_read_param_block_stack
module procedure test_read_param_block_inline_stack
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(3)
  lines = [ &
  ...
  call clearParameterBlock(param)
  call close_param_file(param)
end procedure test_read_param_block_inline_stack
module procedure test_read_param_block_empty_pop
  type(param_file_type) :: param
  call create_test_file(param_filename)
  ...
  call closeParameterBlock(param)
  ! FATAL; return to program
end procedure test_read_param_block_empty_pop
module procedure test_read_param_block_close_unnamed
  type(param_file_type) :: param
  type(string) :: lines(2)
  lines = [ &
      string('ABC%'), &
  ...
  call closeParameterBlock(param)
  ! FATAL; return to program
end procedure test_read_param_block_close_unnamed
module procedure test_read_param_block_close_unopened
  type(param_file_type) :: param
  type(string) :: lines(1)
  lines = string('%CBA')
  call create_test_file(param_filename, lines)
  ...
  call open_param_file(param_filename, param)
  ! FATAL; return to program
end procedure test_read_param_block_close_unopened
module procedure test_read_param_block_unmatched
  type(param_file_type) :: param
  type(string) :: lines(2)
  lines = [ &
      string('ABC%'), &
  ...
  call open_param_file(param_filename, param)
  ! FATAL; return to program
end procedure test_read_param_block_unmatched
module procedure test_open_unallocated_block
  type(param_file_type) :: param
  character(len=*), parameter :: block_name = "ABC"
  call openParameterBlock(param, block_name)
  ! FATAL; return to program
end procedure test_open_unallocated_block
module procedure test_close_unallocated_block
  type(param_file_type) :: param
  call closeParameterBlock(param)
  ! FATAL; return to program
end procedure test_close_unallocated_block
module procedure test_clear_unallocated_block
  type(param_file_type) :: param
  call clearParameterBlock(param)
  ! FATAL; return to program
end procedure test_clear_unallocated_block
module procedure test_read_param_block_outside_block
  type(param_file_type) :: param
  integer :: sample
  type(string) :: lines(3)
  lines = [ &
  ...
  call open_param_file(param_filename, param)
  call read_param(param, sample_param_name, sample)
end procedure test_read_param_block_outside_block
module procedure test_log_version_cs
  type(param_file_type) :: param
  call create_test_file(param_filename)
  ...
  call close_param_file(param)
end procedure test_log_version_cs
module procedure test_log_version_plain
  call log_version(module_name, module_version)
end procedure test_log_version_plain
module procedure test_log_param_int
  type(param_file_type) :: param
  ...
  call close_param_file(param)
end procedure test_log_param_int
module procedure test_log_param_int_array
  type(param_file_type) :: param
  ...
  call log_param(param, module_name, sample_param_name, sample, desc=desc)
  call close_param_file(param)
end procedure test_log_param_int_array
module procedure test_log_param_real
  type(param_file_type) :: param
  ...
  call close_param_file(param)
end procedure test_log_param_real
module procedure test_log_param_real_array
  type(param_file_type) :: param
  ...
  call log_param(param, module_name, sample_param_name, sample, desc=desc, units="")
  call close_param_file(param)
end procedure test_log_param_real_array
module procedure test_log_param_time
  type(param_file_type) :: param
  type(time_type) :: sample
  character(len=*), parameter :: desc = "Parameter description"
  type(string) :: lines(1)
  ...
  call log_param(param, module_name, sample_param_name, sample, desc=desc)
  call close_param_file(param)
end procedure test_log_param_time
module procedure test_log_param_time_as_date
  type(param_file_type) :: param
  type(time_type) :: sample
  character(len=*), parameter :: desc = "Parameter description"
  call set_calendar_type(NOLEAP)
  ...
  call log_param(param, module_name, sample_param_name, sample, desc=desc, &
      log_date=.true.)
  call close_param_file(param)
end procedure test_log_param_time_as_date
module procedure test_log_param_time_as_date_default
  type(param_file_type) :: param
  type(time_type) :: sample
  ...
  call close_param_file(param)
end procedure test_log_param_time_as_date_default
module procedure test_log_param_time_as_date_tick
  type(param_file_type) :: param
  type(time_type) :: sample
  character(len=*), parameter :: desc = "Parameter description"
  call set_calendar_type(NOLEAP)
  ...
  call log_param(param, module_name, sample_param_name, sample, desc=desc, &
      log_date=.true.)
  call close_param_file(param)
end procedure test_log_param_time_as_date_tick
module procedure test_log_param_time_with_unit
  type(param_file_type) :: param
  type(time_type) :: sample
  type(time_type) :: default_date
  character(len=*), parameter :: desc = "Parameter description"
  ...
  call close_param_file(param)
end procedure test_log_param_time_with_unit
module procedure test_log_param_time_with_timeunit
  type(param_file_type) :: param
  type(time_type) :: sample
  integer :: i
  character(len=*), parameter :: desc = "Parameter description"
  ...
  enddo
  call close_param_file(param)
end procedure test_log_param_time_with_timeunit
module procedure test_get_param_int
  type(param_file_type) :: param
  integer :: sample
  call create_test_file(param_filename)
  ...
  call close_param_file(param)
end procedure test_get_param_int
module procedure test_get_param_int_no_read_no_log
  type(param_file_type) :: param
  integer :: sample
  call create_test_file(param_filename)
  ...
  call close_param_file(param)
end procedure test_get_param_int_no_read_no_log
module procedure test_get_param_int_array
  type(param_file_type) :: param
  integer :: sample(3)
  call create_test_file(param_filename)
  ...
  call get_param(param, module_name, sample_param_name, sample)
  call close_param_file(param)
end procedure test_get_param_int_array
module procedure test_get_param_int_array_no_read_no_log
  type(param_file_type) :: param
  integer :: sample(3)
  call create_test_file(param_filename)
  ...
  call get_param(param, module_name, sample_param_name, sample, &
      do_not_read=.true., do_not_log=.true.)
  call close_param_file(param)
end procedure test_get_param_int_array_no_read_no_log
module procedure test_get_param_real
  type(param_file_type) :: param
  real :: sample
  call create_test_file(param_filename)
  ...
  call close_param_file(param)
end procedure test_get_param_real
module procedure test_get_param_real_no_read_no_log
  type(param_file_type) :: param
  real :: sample
  call create_test_file(param_filename)
  ...
  call get_param(param, module_name, sample_param_name, sample, units="", &
      do_not_read=.true., do_not_log=.true.)
  call close_param_file(param)
end procedure test_get_param_real_no_read_no_log
module procedure test_get_param_real_array
  type(param_file_type) :: param
  real :: sample(3)
  call create_test_file(param_filename)
  ...
  call get_param(param, module_name, sample_param_name, sample, units="")
  call close_param_file(param)
end procedure test_get_param_real_array
module procedure test_get_param_real_array_no_read_no_log
  type(param_file_type) :: param
  real :: sample(3)
  call create_test_file(param_filename)
  ...
  call get_param(param, module_name, sample_param_name, sample, units="", &
      do_not_read=.true., do_not_log=.true.)
  call close_param_file(param)
end procedure test_get_param_real_array_no_read_no_log
module procedure test_get_param_char
  type(param_file_type) :: param
  character(len=8) :: sample
  call create_test_file(param_filename)
  ...
  call get_param(param, module_name, sample_param_name, sample)
  call close_param_file(param)
end procedure test_get_param_char
module procedure test_get_param_char_no_read_no_log
  type(param_file_type) :: param
  character(len=8) :: sample
  call create_test_file(param_filename)
  ...
  call get_param(param, module_name, sample_param_name, sample, &
      do_not_read=.true., do_not_log=.true.)
  call close_param_file(param)
end procedure test_get_param_char_no_read_no_log
module procedure test_get_param_char_array
  type(param_file_type) :: param
  character(len=8) :: sample(3)
  call create_test_file(param_filename)
  ...
  call get_param(param, module_name, sample_param_name, sample)
  call close_param_file(param)
end procedure test_get_param_char_array
module procedure test_get_param_logical
  type(param_file_type) :: param
  logical :: sample
  call create_test_file(param_filename)
  ...
  call get_param(param, module_name, sample_param_name, sample)
  call close_param_file(param)
end procedure test_get_param_logical
module procedure test_get_param_logical_no_read_no_log
  type(param_file_type) :: param
  logical :: sample
  call create_test_file(param_filename)
  ...
  call get_param(param, module_name, sample_param_name, sample, &
      do_not_read=.true., do_not_log=.true.)
  call close_param_file(param)
end procedure test_get_param_logical_no_read_no_log
module procedure test_get_param_logical_default
  type(param_file_type) :: param
  logical :: sample
  ...
  call close_param_file(param)
end procedure test_get_param_logical_default
module procedure test_get_param_time
  type(param_file_type) :: param
  type(time_type) :: sample
  call create_test_file(param_filename)
  ...
  call get_param(param, module_name, sample_param_name, sample)
  call close_param_file(param)
end procedure test_get_param_time
module procedure test_get_param_time_no_read_no_log
  type(param_file_type) :: param
  type(time_type) :: sample
  call create_test_file(param_filename)
  ...
  call get_param(param, module_name, sample_param_name, sample, &
      do_not_read=.true., do_not_log=.true.)
  call close_param_file(param)
end procedure test_get_param_time_no_read_no_log
module procedure cleanup_file_parser
  integer :: i
  call delete_test_file(param_filename)
  do i = 1, 4
...
end procedure cleanup_file_parser
module procedure run_file_parser_tests
  ...
  call suite%run()
end procedure run_file_parser_tests
end submodule MOM_file_parser_tests_s
