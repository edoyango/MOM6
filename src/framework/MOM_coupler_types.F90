...
module subroutine coupler_type_data_override(gridname, var, time)
...
module subroutine extract_coupler_type_data(var_in, bc_index, array_out, scale_factor, &
...
module subroutine set_coupler_type_data(array_in, bc_index, var, solubility, scale_factor, &
                                 halo_size, idim, jdim, field_index, turns)
...
module subroutine coupler_type_set_diags(var, diag_name, axes, time)
...
module subroutine coupler_type_send_data(var, Time)
