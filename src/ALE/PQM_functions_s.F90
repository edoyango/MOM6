submodule (PQM_functions) PQM_functions_s
  implicit none
contains
module procedure PQM_reconstruction
...
end procedure PQM_reconstruction
module procedure PQM_limiter
  integer :: k            ! loop index
  integer :: inflexion_l
  integer :: inflexion_r
...
end procedure PQM_limiter
module procedure PQM_boundary_extrapolation
  integer       :: i0, i1
...
end procedure PQM_boundary_extrapolation
module procedure PQM_boundary_extrapolation_v1
  integer :: i0, i1
  integer :: inflexion_l
  integer :: inflexion_r
...
end procedure PQM_boundary_extrapolation_v1
end submodule PQM_functions_s
