submodule (PPM_functions) PPM_functions_s
  implicit none
contains
module procedure PPM_reconstruction
...
end procedure PPM_reconstruction
module procedure PPM_limiter_standard
  integer   :: k              ! Loop index
...
end procedure PPM_limiter_standard
module procedure PPM_monotonicity
  integer   :: k      ! Loop index
...
end procedure PPM_monotonicity
module procedure PPM_boundary_extrapolation
  integer :: i0, i1
...
end procedure PPM_boundary_extrapolation
end submodule PPM_functions_s
