submodule (MOM_hybgen_remap) MOM_hybgen_remap_s
  implicit none
contains
module procedure hybgen_plm_coefs
...
end procedure hybgen_plm_coefs
...
module procedure hybgen_weno_coefs
...
end procedure hybgen_weno_coefs
end submodule MOM_hybgen_remap_s
