submodule (regrid_edge_values) regrid_edge_values_s
  implicit none
contains
...
module procedure average_discontinuous_edge_values
...
end procedure average_discontinuous_edge_values
...
module procedure edge_values_explicit_h2
  integer   :: k        ! loop index
  edge_val(1,1) = u(1)
  edge_val(N,2) = u(N)
...
end procedure edge_values_explicit_h2
module procedure edge_values_explicit_h4
...
end procedure edge_values_explicit_h4
module procedure edge_values_explicit_h4cw
...
end procedure edge_values_explicit_h4cw
module procedure edge_values_implicit_h4
...
end procedure edge_values_implicit_h4
...
module procedure edge_slopes_implicit_h3
  integer               :: i, j                 ! loop indexes
...
end procedure edge_slopes_implicit_h3
module procedure edge_slopes_implicit_h5
...
end procedure edge_slopes_implicit_h5
module procedure edge_values_implicit_h6
  real :: h0, h1, h2, h3       ! cell widths [H]
  real :: hMin                 ! The minimum thickness used in these calculations [H]
...
end procedure edge_values_implicit_h6
module procedure test_line
...
end submodule regrid_edge_values_s
