submodule (MOM_grid_initialize) MOM_grid_initialize_s
  implicit none
contains
module procedure set_grid_metrics
...
end procedure set_grid_metrics
module procedure grid_metrics_chksum
  integer :: halo
...
end procedure grid_metrics_chksum
module procedure set_grid_metrics_from_mosaic
...
end procedure set_grid_metrics_from_mosaic
module procedure set_grid_metrics_cartesian
...
end procedure set_grid_metrics_cartesian
module procedure set_grid_metrics_spherical
...
end procedure set_grid_metrics_spherical
module procedure set_grid_metrics_mercator
  integer :: i, j, isd, ied, jsd, jed
  integer :: I_off, J_off
  type(GPS) :: GP
...
end procedure set_grid_metrics_mercator
module procedure ds_di
...
module procedure Int_dj_dy
  ...
  Int_dj_dy = r
end procedure Int_dj_dy
module procedure extrapolate_metric
...
end procedure initialize_masks
end submodule MOM_grid_initialize_s
