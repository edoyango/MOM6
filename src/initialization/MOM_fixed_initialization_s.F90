submodule (MOM_fixed_initialization) MOM_fixed_initialization_s
  implicit none
contains
module procedure MOM_initialize_fixed
...
end procedure MOM_initialize_fixed
module procedure MOM_initialize_topography
...
end procedure MOM_initialize_topography
end submodule MOM_fixed_initialization_s
