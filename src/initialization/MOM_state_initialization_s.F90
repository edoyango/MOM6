submodule (MOM_state_initialization) MOM_state_initialization_s
#include <MOM_memory.h>
  implicit none
contains
module procedure MOM_initialize_state
...
end procedure MOM_initialize_state
module procedure MOM_initialize_OBCs
...
end procedure MOM_initialize_OBCs
module procedure initialize_thickness_from_file
...
end procedure initialize_thickness_from_file
module procedure adjustEtaToFitBathymetry
...
end procedure adjustEtaToFitBathymetry
module procedure initialize_thickness_uniform
  ...
  call callTree_leave(trim(mdl)//'()')
end procedure initialize_thickness_uniform
module procedure initialize_thickness_list
  ...
  call callTree_leave(trim(mdl)//'()')
end procedure initialize_thickness_list
module procedure initialize_thickness_param
  ...
  call callTree_leave(trim(mdl)//'()')
end procedure initialize_thickness_param
module procedure initialize_thickness_search
  call MOM_error(FATAL,"  MOM_state_initialization.F90, initialize_thickness_search: NOT IMPLEMENTED")
end procedure initialize_thickness_search
module procedure depress_surface
...
end procedure depress_surface
module procedure trim_for_ice
...
end procedure trim_for_ice
module procedure calc_sfc_displacement
...
end procedure calc_sfc_displacement
module procedure cut_off_column_top
...
end procedure cut_off_column_top
module procedure initialize_velocity_from_file
  ...
  call callTree_leave(trim(mdl)//'()')
end procedure initialize_velocity_from_file
module procedure initialize_velocity_zero
  ...
  call callTree_leave(trim(mdl)//'()')
end procedure initialize_velocity_zero
module procedure initialize_velocity_uniform
  integer :: i, j, k, is, ie, js, je, Isq, Ieq, Jsq, Jeq, nz
...
end procedure initialize_velocity_uniform
module procedure initialize_velocity_circular
...
end procedure initialize_velocity_circular
module procedure initialize_temp_salt_from_file
  ...
  call callTree_leave(trim(mdl)//'()')
end procedure initialize_temp_salt_from_file
module procedure initialize_temp_salt_from_profile
  ...
  call callTree_leave(trim(mdl)//'()')
end procedure initialize_temp_salt_from_profile
module procedure initialize_temp_salt_fit
  ...
  call callTree_leave(trim(mdl)//'()')
end procedure initialize_temp_salt_fit
module procedure initialize_temp_salt_linear
  ...
  call callTree_leave(trim(mdl)//'()')
end procedure initialize_temp_salt_linear
module procedure initialize_sponges_file
...
end procedure initialize_sponges_file
module procedure initialize_oda_incupd_file
...
end procedure initialize_oda_incupd_file
module procedure set_velocity_depth_max
  integer :: i, j
  ...
  enddo ; enddo
end procedure set_velocity_depth_max
module procedure set_velocity_depth_min
  integer :: i, j
  do I=G%isd,G%ied-1 ; do j=G%jsd,G%jed
  ...
  do i=G%isd,G%ied ; do J=G%jsd,G%jed-1
    ...
    G%Dopen_v(I,J) = G%Dblock_v(I,J)
  enddo ; enddo
end procedure set_velocity_depth_min
module procedure MOM_temp_salt_initialize_from_Z
...
end procedure MOM_temp_salt_initialize_from_Z
module procedure find_interfaces
...
end procedure find_interfaces
module procedure MOM_state_init_tests
...
end procedure MOM_state_init_tests
end submodule MOM_state_initialization_s
