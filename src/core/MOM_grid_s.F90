submodule (MOM_grid) MOM_grid_s
#include <MOM_memory.h>
  implicit none
contains
module procedure MOM_grid_init
...
end procedure MOM_grid_init
module procedure set_derived_metrics
...
end procedure isPointInCell
module procedure set_first_direction
  G%first_direction = y_first
end procedure set_first_direction
module procedure get_global_grid_size
  call get_global_shape(G%domain, niglobal, njglobal)

end procedure get_global_grid_size
module procedure allocate_metrics
...
end procedure allocate_metrics
module procedure MOM_grid_end
  deallocate(G%Block)
...
end procedure MOM_grid_end
end submodule MOM_grid_s
