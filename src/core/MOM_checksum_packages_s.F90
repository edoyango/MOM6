submodule (MOM_checksum_packages) MOM_checksum_packages_s
...
end procedure MOM_state_chksum_5arg
module procedure MOM_state_chksum_3arg
  ...
  call hchksum(h, mesg//" h",G%HI, haloshift=hs, omit_corners=omit_corners, unscale=GV%H_to_MKS)
end procedure MOM_state_chksum_3arg
module procedure MOM_thermo_chksum
  integer :: hs
  hs=1 ; if (present(haloshift)) hs=haloshift
...
end procedure MOM_thermo_chksum
module procedure MOM_surface_chksum
  integer :: hs
  logical :: sym
  sym = .false. ; if (present(symmetric)) sym = symmetric
...
end procedure MOM_surface_chksum
module procedure MOM_accel_chksum
  logical :: sym
  sym = .false. ; if (present(symmetric)) sym = symmetric
...
end procedure MOM_accel_chksum
module procedure MOM_state_stats
...
end procedure MOM_state_stats
end submodule MOM_checksum_packages_s
