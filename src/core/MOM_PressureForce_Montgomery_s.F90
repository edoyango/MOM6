submodule (MOM_PressureForce_Mont) MOM_PressureForce_Mont_s
#include <MOM_memory.h>
  implicit none
contains
module procedure PressureForce_Mont_nonBouss
...
end procedure PressureForce_Mont_nonBouss
module procedure PressureForce_Mont_Bouss
  real, dimension(SZI_(G),SZJ_(G),SZK_(GV)) :: &
    M, &        ! The Montgomery potential, M = (p/rho + gz) [L2 T-2 ~> m2 s-2].
...
end procedure PressureForce_Mont_Bouss
module procedure Set_pbce_Bouss
...
end procedure Set_pbce_Bouss
module procedure Set_pbce_nonBouss
  real, dimension(SZI_(G),SZJ_(G)) :: &
...
end procedure Set_pbce_nonBouss
module procedure PressureForce_Mont_init
  logical :: use_EOS
...
end procedure PressureForce_Mont_init
end submodule MOM_PressureForce_Mont_s
