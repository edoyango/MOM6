submodule (MOM_transcribe_grid) MOM_transcribe_grid_s
  implicit none
contains
module procedure copy_dyngrid_to_MOM_grid
...
end procedure copy_dyngrid_to_MOM_grid
module procedure copy_MOM_grid_to_dyngrid
  integer :: isd, ied, jsd, jed      ! Common data domains.
  integer :: IsdB, IedB, JsdB, JedB  ! Common data domains.
  integer :: ido, jdo, Ido2, Jdo2    ! Indexing offsets between the grids.
  integer :: Igst, Jgst              ! Global starting indices.
...
end procedure copy_MOM_grid_to_dyngrid
end submodule MOM_transcribe_grid_s
