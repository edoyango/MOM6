...
!>@}
  ...
  interface
module subroutine step_MOM_dyn_split_RK2(u_inst, v_inst, h, tv, visc, Time_local, dt, forces, &
...
module subroutine register_restarts_dyn_split_RK2(HI, GV, US, param_file, CS, restart_CS, uh, vh)
...
module subroutine remap_dyn_split_RK2_aux_vars(G, GV, CS, h_old_u, h_old_v, h_new_u, h_new_v, ALE_CSp)
  type(ocean_grid_type),            intent(inout) :: G        !< ocean grid structure
  type(verticalGrid_type),          intent(in)    :: GV       !< ocean vertical grid structure
  type(MOM_dyn_split_RK2_CS),       pointer       :: CS       !< module control structure
  real, dimension(SZIB_(G),SZJ_(G),SZK_(GV)), &
...
module subroutine init_dyn_split_RK2_diabatic(diabatic_CSp, CS)
  type(diabatic_CS),                intent(in) :: diabatic_CSp !< diabatic structure
  type(MOM_dyn_split_RK2_CS),       pointer    :: CS           !< module control structure

end subroutine init_dyn_split_RK2_diabatic
module subroutine initialize_dyn_split_RK2(u, v, h, tv, uh, vh, eta, Time, G, GV, US, param_file, &
...
module subroutine end_dyn_split_RK2(CS)
  type(MOM_dyn_split_RK2_CS), pointer :: CS  !< module control structure
