...
subroutine calc_isoneutral_slopes(G, GV, US, h, e, tv, dt_kappa_smooth, use_stanley, slope_x, slope_y, &
  ...
  !$omp   drho_dT, drho_dS, drho_dT_dT_h)
...
#ifdef DEBUG
    call Bchksum(drho_dT, "calc_isoneutral_slopes: drho_dT before zonal", G%HI)
    call Bchksum(drho_dS, "calc_isoneutral_slopes: drho_dS before zonal", G%HI)
#endif
...
#ifdef DEBUG
    call Bchksum(drho_dT, "calc_isoneutral_slopes: drho_dT before merid", G%HI)
    call Bchksum(drho_dS, "calc_isoneutral_slopes: drho_dS before merid", G%HI)
#endif
