submodule (MOM_check_scaling) MOM_check_scaling_s
  implicit none
contains
module procedure check_MOM6_scaling_factors
...
end procedure check_MOM6_scaling_factors
module procedure compose_dimension_list
  ns = 0
...
end procedure compose_dimension_list
module procedure add_scaling
  integer :: iend
  iend = index(scaling, "~>")
  if (iend <= 1) then
...
end procedure add_scaling
end submodule MOM_check_scaling_s
