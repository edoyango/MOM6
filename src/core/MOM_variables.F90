...
type, public :: porous_barrier_type
  ...
  interface
module subroutine allocate_surface_state(sfc_state, G, use_temperature, do_integrals, &
...
module subroutine deallocate_surface_state(sfc_state)
...
module subroutine rotate_surface_state(sfc_state_in, sfc_state, G, turns)
...
module subroutine alloc_BT_cont_type(BT_cont, G, GV, alloc_faces)
