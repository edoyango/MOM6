submodule (MOM_isopycnal_slopes) MOM_isopycnal_slopes_s
#include <MOM_memory.h>
  implicit none
contains
module procedure calc_isoneutral_slopes
...
end procedure calc_isoneutral_slopes
module procedure vert_fill_TS
...
end procedure vert_fill_TS
end submodule MOM_isopycnal_slopes_s
