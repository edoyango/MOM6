submodule (MOM_dynamics_unsplit) MOM_dynamics_unsplit_s
#include <MOM_memory.h>
  implicit none
contains
module procedure step_MOM_dyn_unsplit
...
end procedure step_MOM_dyn_unsplit
module procedure register_restarts_dyn_unsplit
...
end procedure register_restarts_dyn_unsplit
module procedure initialize_dyn_unsplit
...
end procedure initialize_dyn_unsplit
module procedure end_dyn_unsplit
  ...
  deallocate(CS)
end procedure end_dyn_unsplit
end submodule MOM_dynamics_unsplit_s
