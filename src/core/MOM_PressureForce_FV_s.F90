submodule (MOM_PressureForce_FV) MOM_PressureForce_FV_s
#include <MOM_memory.h>
  implicit none
contains
module procedure PressureForce_FV_nonBouss
...
end procedure PressureForce_FV_nonBouss
module procedure PressureForce_FV_Bouss
...
end procedure PressureForce_FV_Bouss
module procedure PressureForce_FV_init
...
end procedure PressureForce_FV_init
end submodule MOM_PressureForce_FV_s
