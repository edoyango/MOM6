...
#include <MOM_memory.h>
  implicit none
contains
module procedure continuity_PPM
...
end procedure continuity_PPM
module procedure continuity_3d_fluxes
  real :: h_W(SZI_(G),SZJ_(G),SZK_(GV)) ! West edge thicknesses in the zonal PPM reconstruction [H ~> m or kg m-2]
  real :: h_E(SZI_(G),SZJ_(G),SZK_(GV)) ! East edge thicknesses in the zonal PPM reconstruction [H ~> m or kg m-2]
  real :: h_S(SZI_(G),SZJ_(G),SZK_(GV)) ! South edge thicknesses in the meridional PPM reconstruction [H ~> m or kg m-2]
  real :: h_N(SZI_(G),SZJ_(G),SZK_(GV)) ! North edge thicknesses in the meridional PPM reconstruction [H ~> m or kg m-2]
...
end procedure continuity_3d_fluxes
module procedure continuity_2d_fluxes
  real :: h_W(SZI_(G),SZJ_(G),SZK_(GV)) ! West edge thicknesses in the zonal PPM reconstruction [H ~> m or kg m-2]
  real :: h_E(SZI_(G),SZJ_(G),SZK_(GV)) ! East edge thicknesses in the zonal PPM reconstruction [H ~> m or kg m-2]
  real :: h_S(SZI_(G),SZJ_(G),SZK_(GV)) ! South edge thicknesses in the meridional PPM reconstruction [H ~> m or kg m-2]
  real :: h_N(SZI_(G),SZJ_(G),SZK_(GV)) ! North edge thicknesses in the meridional PPM reconstruction [H ~> m or kg m-2]
...
end procedure continuity_2d_fluxes
module procedure continuity_adjust_vel
...
end procedure continuity_adjust_vel
module procedure continuity_zonal_convergence
  real :: h_min  ! The minimum layer thickness [H ~> m or kg m-2].  h_min could be 0.
  integer :: i, j, k
...
end procedure continuity_zonal_convergence
module procedure continuity_merdional_convergence
  real :: h_min  ! The minimum layer thickness [H ~> m or kg m-2].  h_min could be 0.
  integer :: i, j, k
  call cpu_clock_begin(id_clock_update)
...
end procedure continuity_merdional_convergence
module procedure zonal_edge_thickness
...
end procedure zonal_edge_thickness
module procedure meridional_edge_thickness
  type(cont_loop_bounds_type) :: LB
  integer :: i, j, k, ish, ieh, jsh, jeh, nz
  call cpu_clock_begin(id_clock_reconstruct)
...
end procedure meridional_edge_thickness
...
module procedure zonal_BT_mass_flux
...
end procedure zonal_BT_mass_flux
module procedure zonal_flux_layer
...
end procedure zonal_flux_layer
...
module procedure meridional_BT_mass_flux
...
end procedure meridional_BT_mass_flux
module procedure merid_flux_layer
  real :: CFL ! The CFL number based on the local velocity and grid spacing [nondim]
...
end procedure merid_flux_layer
...
module procedure meridional_flux_adjust
  real, dimension(SZI_(G),SZK_(GV)) :: &
...
end procedure meridional_flux_adjust
module procedure set_merid_BT_cont
  real, dimension(SZI_(G)) :: &
...
end procedure set_merid_BT_cont
...
module procedure PPM_limit_CW84
...
module procedure continuity_PPM_init
...
end procedure continuity_PPM_init
module procedure continuity_PPM_stencil
  stencil = 3 ; if (CS%simple_2nd) stencil = 2 ; if (CS%upwind_1st) stencil = 1

end procedure continuity_PPM_stencil
module procedure set_continuity_loop_bounds
...
end procedure set_continuity_loop_bounds
