...
contains
  ...
  interface
real elemental module function density_elem_buggy_Wright(this, T, S, pressure)
...
real elemental module function density_anomaly_elem_buggy_Wright(this, T, S, pressure, rho_ref)
  class(buggy_Wright_EOS), intent(in) :: this !< This EOS
  real, intent(in) :: T        !< potential temperature relative to the surface [degC].
  real, intent(in) :: S        !< salinity [PSU].
  real, intent(in) :: pressure !< pressure [Pa].
...
real elemental module function spec_vol_elem_buggy_Wright(this, T, S, pressure)
  class(buggy_Wright_EOS), intent(in) :: this !< This EOS
  real,           intent(in) :: T        !< potential temperature relative to the surface [degC].
  real,           intent(in) :: S        !< salinity [PSU].
  real,           intent(in) :: pressure !< pressure [Pa].
...
real elemental module function spec_vol_anomaly_elem_buggy_Wright(this, T, S, pressure, spv_ref)
  class(buggy_Wright_EOS), intent(in) :: this !< This EOS
  real,           intent(in) :: T        !< potential temperature relative to the surface [degC].
  real,           intent(in) :: S        !< salinity [PSU].
  real,           intent(in) :: pressure !< pressure [Pa].
...
elemental module subroutine calculate_density_derivs_elem_buggy_Wright(this, T, S, pressure, drho_dT, drho_dS)
  class(buggy_Wright_EOS), intent(in) :: this !< This EOS
  real,               intent(in)  :: T        !< Potential temperature relative to the surface [degC]
  real,               intent(in)  :: S        !< Salinity [PSU]
  real,               intent(in)  :: pressure !< Pressure [Pa]
...
elemental module subroutine calculate_density_second_derivs_elem_buggy_Wright(this, T, S, pressure, &
...
elemental module subroutine calculate_specvol_derivs_elem_buggy_Wright(this, T, S, pressure, dSV_dT, dSV_dS)
  class(buggy_Wright_EOS), intent(in) :: this   !< This EOS
...
elemental module subroutine calculate_compress_elem_buggy_Wright(this, T, S, pressure, rho, drho_dp)
  class(buggy_Wright_EOS), intent(in) :: this !< This EOS
  real,               intent(in)  :: T        !< Potential temperature relative to the surface [degC]
  real,               intent(in)  :: S        !< Salinity [PSU]
  real,               intent(in)  :: pressure !< Pressure [Pa]
...
module subroutine avg_spec_vol_buggy_Wright(T, S, p_t, dp, SpV_avg, start, npts)
...
module subroutine EoS_fit_range_buggy_Wright(this, T_min, T_max, S_min, S_max, p_min, p_max)
  class(buggy_Wright_EOS), intent(in) :: this   !< This EOS
...
module subroutine int_density_dz_wright(T, S, z_t, z_b, rho_ref, rho_0, G_e, HI, &
...
module subroutine int_spec_vol_dp_wright(T, S, p_t, p_b, spv_ref, HI, dza, &
...
module subroutine calculate_density_array_buggy_Wright(this, T, S, pressure, rho, start, npts, rho_ref)
  class(buggy_Wright_EOS),  intent(in) :: this !< This EOS
...
module subroutine calculate_spec_vol_array_buggy_Wright(this, T, S, pressure, specvol, start, npts, spv_ref)
  class(buggy_Wright_EOS),  intent(in) :: this !< This EOS
  real, dimension(:), intent(in)  :: T         !< Potential temperature relative to the surface [degC]
  real, dimension(:), intent(in)  :: S         !< Salinity [PSU]
  real, dimension(:), intent(in)  :: pressure  !< Pressure [Pa]
...
module subroutine set_params_buggy_Wright(this, use_Wright_2nd_deriv_bug)
