...
contains
  ...
  interface
real elemental module function density_elem_Wright_full(this, T, S, pressure)
...
real elemental module function density_anomaly_elem_Wright_full(this, T, S, pressure, rho_ref)
  class(Wright_full_EOS), intent(in) :: this !< This EOS
  real, intent(in) :: T        !< Potential temperature relative to the surface [degC]
  real, intent(in) :: S        !< Salinity [PSU]
  real, intent(in) :: pressure !< Pressure [Pa]
...
real elemental module function spec_vol_elem_Wright_full(this, T, S, pressure)
  class(Wright_full_EOS), intent(in) :: this !< This EOS
  real,           intent(in) :: T        !< Potential temperature relative to the surface [degC]
  real,           intent(in) :: S        !< Salinity [PSU]
  real,           intent(in) :: pressure !< Pressure [Pa]
...
real elemental module function spec_vol_anomaly_elem_Wright_full(this, T, S, pressure, spv_ref)
  class(Wright_full_EOS), intent(in) :: this !< This EOS
  real,           intent(in) :: T        !< Potential temperature relative to the surface [degC]
  real,           intent(in) :: S        !< Salinity [PSU]
  real,           intent(in) :: pressure !< Pressure [Pa]
...
elemental module subroutine calculate_density_derivs_elem_Wright_full(this, T, S, pressure, drho_dT, drho_dS)
  class(Wright_full_EOS), intent(in) :: this  !< This EOS
  real,               intent(in)  :: T        !< Potential temperature relative to the surface [degC]
  real,               intent(in)  :: S        !< Salinity [PSU]
  real,               intent(in)  :: pressure !< Pressure [Pa]
...
elemental module subroutine calculate_density_second_derivs_elem_Wright_full(this, T, S, pressure, &
...
elemental module subroutine calculate_specvol_derivs_elem_Wright_full(this,T, S, pressure, dSV_dT, dSV_dS)
  class(Wright_full_EOS), intent(in) :: this     !< This EOS
...
elemental module subroutine calculate_compress_elem_Wright_full(this, T, S, pressure, rho, drho_dp)
  class(Wright_full_EOS), intent(in) :: this  !< This EOS
  real,               intent(in)  :: T        !< Potential temperature relative to the surface [degC]
  real,               intent(in)  :: S        !< Salinity [PSU]
  real,               intent(in)  :: pressure !< Pressure [Pa]
...
module subroutine avg_spec_vol_Wright_full(T, S, p_t, dp, SpV_avg, start, npts)
...
module subroutine EoS_fit_range_Wright_full(this, T_min, T_max, S_min, S_max, p_min, p_max)
  class(Wright_full_EOS), intent(in) :: this !< This EOS
...
module subroutine int_density_dz_wright_full(T, S, z_t, z_b, rho_ref, rho_0, G_e, HI, &
...
module subroutine int_spec_vol_dp_wright_full(T, S, p_t, p_b, spv_ref, HI, dza, &
...
module subroutine calculate_density_array_Wright_full(this, T, S, pressure, rho, start, npts, rho_ref)
  class(Wright_full_EOS), intent(in) :: this  !< This EOS
...
module subroutine calculate_spec_vol_array_Wright_full(this, T, S, pressure, specvol, start, npts, spv_ref)
  class(Wright_full_EOS), intent(in) :: this  !< This EOS
  real, dimension(:), intent(in)  :: T        !< Potential temperature relative to the surface [degC]
  real, dimension(:), intent(in)  :: S        !< Salinity [PSU]
  real, dimension(:), intent(in)  :: pressure !< Pressure [Pa]
