...
interface
  ...
  interface
  real module function a_density_fn(this, T, S, pressure, rho_ref)
    class(EOS_base), intent(in) :: this     !< This EOS
    real,           intent(in) :: T        !< Potential temperature relative to the surface [degC]
    real,           intent(in) :: S        !< Salinity [PSU]
    real,           intent(in) :: pressure !< Pressure [Pa]
  ...
  module subroutine a_calculate_density_scalar(this, T, S, pressure, rho, rho_ref)
    class(EOS_base), intent(in) :: this     !< This EOS
    real,           intent(in)  :: T        !< Potential temperature relative to the surface [degC]
    real,           intent(in)  :: S        !< Salinity [PSU]
    real,           intent(in)  :: pressure !< Pressure [Pa]
  ...
  module subroutine a_calculate_density_array(this, T, S, pressure, rho, start, npts, rho_ref)
    class(EOS_base), intent(in) :: this     !< This EOS
  ...
  real module function a_spec_vol_fn(this, T, S, pressure, spv_ref)
    class(EOS_base), intent(in) :: this     !< This EOS
    real,           intent(in) :: T        !< Potential temperature relative to the surface [degC]
    real,           intent(in) :: S        !< Salinity [PSU]
    real,           intent(in) :: pressure !< Pressure [Pa]
  ...
  module subroutine a_calculate_spec_vol_scalar(this, T, S, pressure, specvol, spv_ref)
    class(EOS_base), intent(in) :: this     !< This EOS
    real,           intent(in)  :: T        !< Potential temperature relative to the surface [degC]
    real,           intent(in)  :: S        !< Salinity [PSU]
    real,           intent(in)  :: pressure !< Pressure [Pa]
  ...
  module subroutine a_calculate_spec_vol_array(this, T, S, pressure, specvol, start, npts, spv_ref)
    class(EOS_base), intent(in) :: this     !< This EOS
    real, dimension(:), intent(in)  :: T        !< Potential temperature relative to the surface [degC]
    real, dimension(:), intent(in)  :: S        !< Salinity [PSU]
    real, dimension(:), intent(in)  :: pressure !< Pressure [Pa]
  ...
  module subroutine a_calculate_density_derivs_scalar(this, T, S, P, drho_dT, drho_dS)
    class(EOS_base), intent(in) :: this !< This EOS
  ...
  module subroutine a_calculate_density_derivs_array(this, T, S, pressure, drho_dT, drho_dS, start, npts)
    class(EOS_base),    intent(in)  :: this     !< This EOS
    real, dimension(:), intent(in)  :: T        !< Potential temperature relative to the surface [degC]
    real, dimension(:), intent(in)  :: S        !< Salinity [PSU]
    real, dimension(:), intent(in)  :: pressure !< Pressure [Pa]
  ...
  module subroutine a_calculate_density_second_derivs_scalar(this, T, S, pressure, &
                     drho_ds_ds, drho_ds_dt, drho_dt_dt, drho_ds_dp, drho_dt_dp)
    class(EOS_base), intent(in)  :: this       !< This EOS
    real,            intent(in)  :: T          !< Potential temperature referenced to 0 dbar
    real,            intent(in)  :: S          !< Salinity [PSU]
  ...
  module subroutine a_calculate_density_second_derivs_array(this, T, S, pressure, &
  ...
  module subroutine a_calculate_specvol_derivs_array(this, T, S, pressure, dSV_dT, dSV_dS, start, npts)
    class(EOS_base),    intent(in)    :: this     !< This EOS
  ...
  module subroutine a_calculate_compress_array(this, T, S, pressure, rho, drho_dp, start, npts)
    class(EOS_base),    intent(in)  :: this     !< This EOS
    real, dimension(:), intent(in)  :: T        !< Potential temperature relative to the surface [degC]
    real, dimension(:), intent(in)  :: S        !< Salinity [PSU]
    real, dimension(:), intent(in)  :: pressure !< Pressure [Pa]
