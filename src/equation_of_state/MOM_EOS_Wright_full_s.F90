submodule (MOM_EOS_Wright_full) MOM_EOS_Wright_full_s
  implicit none
contains
module procedure density_elem_Wright_full
...
end procedure density_elem_Wright_full
module procedure density_anomaly_elem_Wright_full
  real :: al0     ! The specific volume at 0 lambda in the Wright EOS [m3 kg-1]
...
end procedure density_anomaly_elem_Wright_full
module procedure spec_vol_elem_Wright_full
  real :: al0     ! The specific volume at 0 lambda in the Wright EOS [m3 kg-1]
  real :: p0      ! The pressure offset in the Wright EOS [Pa]
...
end procedure spec_vol_elem_Wright_full
module procedure spec_vol_anomaly_elem_Wright_full
  real :: al0     ! The specific volume at 0 lambda in the Wright EOS [m3 kg-1]
  real :: p0      ! The pressure offset in the Wright EOS [Pa]
  real :: lambda  ! The sound speed squared at 0 alpha in the Wright EOS [m2 s-2], perhaps with
  real :: al_TS   ! The contributions of temperature and salinity to al0 [m3 kg-1]
...
end procedure spec_vol_anomaly_elem_Wright_full
module procedure calculate_density_derivs_elem_Wright_full
  real :: al0     ! The specific volume at 0 lambda in the Wright EOS [m3 kg-1]
  real :: p0      ! The pressure offset in the Wright EOS [Pa]
  real :: lambda  ! The sound speed squared at 0 alpha in the Wright EOS [m2 s-2]
...
end procedure calculate_density_derivs_elem_Wright_full
module procedure calculate_density_second_derivs_elem_Wright_full
  real :: al0     ! The specific volume at 0 lambda in the Wright EOS [m3 kg-1]
  real :: lambda  ! The sound speed squared at 0 alpha in the Wright EOS [m2 s-2]
...
end procedure calculate_density_second_derivs_elem_Wright_full
module procedure calculate_specvol_derivs_elem_Wright_full
  real :: p0      ! The pressure offset in the Wright EOS [Pa]
  real :: lambda  ! The sound speed squared at 0 alpha in the Wright EOS [m2 s-2]
...
end procedure calculate_specvol_derivs_elem_Wright_full
module procedure calculate_compress_elem_Wright_full
  real :: al0     ! The specific volume at 0 lambda in the Wright EOS [m3 kg-1]
  real :: p0      ! The pressure offset in the Wright EOS [Pa]
  real :: lambda  ! The sound speed squared at 0 alpha in the Wright EOS [m2 s-2]
  real :: I_denom ! The inverse of the denominator of density in the Wright EOS [s2 m-2]
...
end procedure calculate_compress_elem_Wright_full
module procedure avg_spec_vol_Wright_full
...
end procedure avg_spec_vol_Wright_full
module procedure EoS_fit_range_Wright_full
...
end procedure EoS_fit_range_Wright_full
module procedure int_density_dz_wright_full
...
end procedure int_density_dz_wright_full
module procedure int_spec_vol_dp_wright_full
  ...
  if (present(inty_dza)) then ; do J=Jsq,Jeq ; do i=HI%isc,HI%iec
    ...
    inty_dza(i,j) = C1_90*(7.0*(intp(1)+intp(5)) + 32.0*(intp(2)+intp(4)) + &
                           12.0*intp(3))
  enddo ; enddo ; endif
end procedure int_spec_vol_dp_wright_full
module procedure calculate_density_array_Wright_full
  integer :: j
...
end procedure calculate_density_array_Wright_full
module procedure calculate_spec_vol_array_Wright_full
  integer :: j
...
end procedure calculate_spec_vol_array_Wright_full
end submodule MOM_EOS_Wright_full_s
