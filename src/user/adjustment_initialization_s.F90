submodule (adjustment_initialization) adjustment_initialization_s
#include <MOM_memory.h>
  implicit none
contains
module procedure adjustment_initialize_thickness
...
end procedure adjustment_initialize_thickness
module procedure adjustment_initialize_temperature_salinity
  real :: x, y, yy          ! Fractional positions in the x- and y-directions [nondim]
...
end procedure adjustment_initialize_temperature_salinity
end submodule adjustment_initialization_s
