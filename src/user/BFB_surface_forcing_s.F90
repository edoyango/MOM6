submodule (BFB_surface_forcing) BFB_surface_forcing_s
  implicit none
contains
module procedure BFB_buoyancy_forcing
...
end procedure BFB_buoyancy_forcing
module procedure BFB_surface_forcing_init
...
end procedure BFB_surface_forcing_init
end submodule BFB_surface_forcing_s
