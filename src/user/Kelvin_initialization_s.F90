submodule (Kelvin_initialization) Kelvin_initialization_s
#include <MOM_memory.h>
  implicit none
contains
module procedure register_Kelvin_OBC
...
end procedure register_Kelvin_OBC
module procedure Kelvin_OBC_end
  if (associated(CS)) then
    deallocate(CS)
  endif
end procedure Kelvin_OBC_end
module procedure Kelvin_initialize_topography
...
end procedure Kelvin_initialize_topography
module procedure Kelvin_set_OBC_data
...
end procedure Kelvin_set_OBC_data
end submodule Kelvin_initialization_s
