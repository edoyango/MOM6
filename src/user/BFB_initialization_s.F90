submodule (BFB_initialization) BFB_initialization_s
#include <MOM_memory.h>
  implicit none
contains
module procedure BFB_set_coord
...
end procedure BFB_set_coord
module procedure BFB_initialize_sponges_southonly
...
end procedure BFB_initialize_sponges_southonly
end submodule BFB_initialization_s
