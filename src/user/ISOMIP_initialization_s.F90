submodule (ISOMIP_initialization) ISOMIP_initialization_s
#include <MOM_memory.h>
  implicit none
contains
module procedure ISOMIP_initialize_topography
...
end procedure ISOMIP_initialize_topography
module procedure ISOMIP_initialize_thickness
...
end procedure ISOMIP_initialize_thickness
module procedure ISOMIP_initialize_temperature_salinity
  real      :: rho_sur, rho_bot  ! Surface and bottom densities [R ~> kg m-3]
...
end procedure ISOMIP_initialize_temperature_salinity
module procedure ISOMIP_initialize_sponges
...
end procedure ISOMIP_initialize_sponges
end submodule ISOMIP_initialization_s
