...
! vary with the Boussinesq approximation, the Boussinesq variant is given first.
  ...
  interface
module subroutine seamount_initialize_topography( D, G, param_file, max_depth )
...
module subroutine seamount_initialize_thickness (h, depth_tot, G, GV, US, param_file, just_read)
...
module subroutine seamount_initialize_temperature_salinity(T, S, h, G, GV, US, param_file, just_read)
