submodule (DOME2d_initialization) DOME2d_initialization_s
#include <MOM_memory.h>
  implicit none
contains
module procedure DOME2d_initialize_topography
...
end procedure DOME2d_initialize_topography
module procedure DOME2d_initialize_thickness
...
end procedure DOME2d_initialize_thickness
module procedure DOME2d_initialize_temperature_salinity
  real    :: x                  ! Fractional horizontal positions [nondim]
...
end procedure DOME2d_initialize_temperature_salinity
module procedure DOME2d_initialize_sponges
...
end procedure DOME2d_initialize_sponges
end submodule DOME2d_initialization_s
