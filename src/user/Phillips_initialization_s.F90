submodule (Phillips_initialization) Phillips_initialization_s
#include <MOM_memory.h>
  implicit none
contains
module procedure Phillips_initialize_thickness
...
end procedure Phillips_initialize_thickness
module procedure Phillips_initialize_velocity
...
end procedure Phillips_initialize_velocity
module procedure Phillips_initialize_sponges
  real :: eta0(SZK_(GV)+1)  ! The 1-d nominal positions of the interfaces [Z ~> m]
...
end procedure Phillips_initialize_sponges
module procedure sech
  if (abs(x) > 228.) then
    sech = 0.0
  else
...
module procedure Phillips_initialize_topography
  real :: PI       ! The ratio of the circumference of a circle to its diameter [nondim]
...
end procedure Phillips_initialize_topography
end submodule Phillips_initialization_s
