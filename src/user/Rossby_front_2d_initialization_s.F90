submodule (Rossby_front_2d_initialization) Rossby_front_2d_initialization_s
#include <MOM_memory.h>
  implicit none
contains
module procedure Rossby_front_initialize_thickness
...
end procedure Rossby_front_initialize_thickness
module procedure Rossby_front_initialize_temperature_salinity
...
end procedure Rossby_front_initialize_temperature_salinity
module procedure Rossby_front_initialize_velocity
  real    :: T_range      ! Range of temperatures over the vertical [C ~> degC]
  real    :: T_ref        ! Reference temperature within the surface layer [C ~> degC]
  real    :: S_ref        ! Reference salinity within the surface layer [S ~> ppt]
...
end submodule Rossby_front_2d_initialization_s
