submodule (dumbbell_initialization) dumbbell_initialization_s
#include <MOM_memory.h>
  implicit none
contains
module procedure dumbbell_initialize_topography
...
end procedure dumbbell_initialize_topography
module procedure dumbbell_initialize_thickness
...
end procedure dumbbell_initialize_thickness
module procedure dumbbell_initialize_temperature_salinity
  integer :: i, j, k, is, ie, js, je, nz
  real    :: S_surf    ! The surface salinity [S ~> ppt]
  real    :: S_range   ! The range of salinities in this test case [S ~> ppt]
...
end procedure dumbbell_initialize_temperature_salinity
module procedure dumbbell_initialize_sponges
...
end procedure dumbbell_initialize_sponges
end submodule dumbbell_initialization_s
