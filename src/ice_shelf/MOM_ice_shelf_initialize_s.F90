submodule (MOM_ice_shelf_initialize) MOM_ice_shelf_initialize_s
#include <MOM_memory.h>
  implicit none
contains
module procedure initialize_ice_thickness
...
end procedure initialize_ice_thickness
module procedure initialize_ice_thickness_from_file
  ...
  if (.not.hmask_set) then
    ...
    do j=jsc,jec
      ...
      enddo
    enddo
end procedure initialize_ice_thickness_from_file
module procedure initialize_ice_thickness_channel
...
end procedure initialize_ice_thickness_channel
module procedure initialize_ice_shelf_boundary_channel
 ...
 ! upstream boundary - set either dirichlet or flux condition
    ...
    enddo
  enddo
end procedure initialize_ice_shelf_boundary_channel
module procedure initialize_ice_flow_from_file
...
end procedure initialize_ice_flow_from_file
module procedure initialize_ice_shelf_boundary_from_file
...
end procedure initialize_ice_shelf_boundary_from_file
module procedure initialize_ice_C_basal_friction
...
end procedure initialize_ice_C_basal_friction
module procedure initialize_ice_AGlen
...
end procedure initialize_ice_AGlen
module procedure initialize_ice_SMB
...
end procedure initialize_ice_SMB
end submodule MOM_ice_shelf_initialize_s
