submodule (MOM_oda_driver_mod) MOM_oda_driver_mod_s
#include <MOM_memory.h>
  implicit none
contains
module procedure init_oda
...
end procedure init_oda
module procedure set_prior_tracer
...
end procedure set_prior_tracer
module procedure get_posterior_tracer
...
end procedure get_posterior_tracer
module procedure oda
...
module procedure get_bias_correction_tracer
...
end procedure get_bias_correction_tracer
module procedure oda_end
end procedure oda_end
module procedure init_ocean_ensemble
...
!  allocate(CS%id_ssh(ens_size), source=-1)
  ...
  return
end procedure init_ocean_ensemble
module procedure set_analysis_time
...
end procedure set_analysis_time
module procedure apply_oda_tracer_increments
  integer :: i, j
  integer :: isc, iec, jsc, jec
...
end procedure apply_oda_tracer_increments
  module procedure set_up_global_tgrid
  ...
  end procedure set_up_global_tgrid
end submodule MOM_oda_driver_mod_s
