submodule (ocn_comp_mct) ocn_comp_mct_s
#include <MOM_memory.h>
  implicit none
contains
module procedure ocn_init_mct
...
end procedure ocn_init_mct
module procedure ocn_run_mct
  type(ESMF_time) :: time_var                 !< ESMF_time variable to query time
...
end procedure ocn_run_mct
module procedure ocn_final_mct
    call ocean_model_end(glb%ocn_public, glb%ocn_state, glb%ocn_state%Time)

end procedure ocn_final_mct
module procedure ocn_SetGSMap_mct
...
end procedure ocn_SetGSMap_mct
module procedure ocn_domain_mct
...
end procedure ocn_domain_mct
module procedure get_runtype
...
end procedure IOB_allocate
end submodule ocn_comp_mct_s
