...
type, public :: ocean_state_type
  ...
  interface
module subroutine ocean_model_init(Ocean_sfc, OS, Time_init, Time_in, gas_fields_ocn, input_restart_file)
...
module subroutine ocean_model_restart(OS, timestamp, restartname)
