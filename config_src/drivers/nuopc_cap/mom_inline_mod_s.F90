submodule (mom_inline_mod) mom_inline_mod_s
  implicit none
contains
module procedure mom_inline_init
...
end procedure mom_inline_init
module procedure mom_inline_run
...
end procedure mom_inline_run
end submodule mom_inline_mod_s
