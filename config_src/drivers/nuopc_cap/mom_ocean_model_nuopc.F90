...
type, public :: ocean_state_type ; private
  ...
  interface
module subroutine ocean_model_init(Ocean_sfc, OS, Time_init, Time_in, gas_fields_ocn, input_restart_file, inst_index)
...
module subroutine update_ocean_model(Ice_ocean_boundary, OS, Ocean_sfc, &
...
module subroutine ocean_model_restart(OS, timestamp, restartname, stoch_restartname, num_rest_files)
...
module subroutine ocean_model_end(Ocean_sfc, Ocean_state, Time, write_restart)
...
module subroutine initialize_ocean_public_type(input_domain, Ocean_sfc, diag, maskmap, &
                                        gas_fields_ocn)
...
module subroutine query_ocean_state(OS, use_waves, NumWaveBands, Wavenumbers, unscale, wave_method, use_MARBL)
...
real module function get_eps_omesh(OS)
  type(ocean_state_type) :: OS
end function get_eps_omesh
  end interface
