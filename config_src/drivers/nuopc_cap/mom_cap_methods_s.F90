submodule (MOM_cap_methods) MOM_cap_methods_s
  implicit none
contains
module procedure mom_set_geomtype
  geomtype = geomtype_in

end procedure mom_set_geomtype
module procedure mom_import
...
end procedure mom_import
module procedure mom_export
...
end procedure State_GetFldPtr_1d
...
end procedure State_GetFldPtr_2d
...
end procedure State_GetImport_2d
...
end procedure State_GetImport_3d
module procedure State_SetExport
  type(ESMF_StateItem_Flag)     :: itemFlag
...
end procedure State_SetExport
module procedure state_diagnose
  integer                         :: i,j,n
  type(ESMf_Field)                :: lfield
...
end procedure state_diagnose
module procedure field_getfldptr
...
end procedure field_getfldptr
module procedure ChkErr
  integer :: lrc
  ChkErr = .false.
  lrc = rc
...
end procedure ChkErr
end submodule MOM_cap_methods_s
