submodule (MOM_cap_mod) MOM_cap_mod_s
  implicit none
contains
module procedure SetServices
...
end procedure SetServices
module procedure InitializeP0
...
end procedure InitializeP0
module procedure InitializeAdvertise
  type(ESMF_VM)                          :: vm
...
end procedure InitializeAdvertise
module procedure InitializeRealize
  type(ESMF_VM)                              :: vm
...
end procedure InitializeRealize
module procedure DataInitialize
...
end procedure DataInitialize
module procedure ModelAdvance
  integer                                :: userRc
...
end procedure ModelAdvance
module procedure ModelSetRunClock
...
end procedure ModelSetRunClock
module procedure ocean_model_finalize
...
end procedure ocean_model_finalize
module procedure State_SetScalar
  type(ESMF_Field)                :: field
...
end procedure State_SetScalar
module procedure MOM_RealizeFields
  integer                     :: i
  type(ESMF_Field)            :: field
...
end procedure MOM_RealizeFields
module procedure fld_list_add
  integer :: rc
...
end procedure fld_list_add
module procedure shr_log_setLogUnit
end procedure shr_log_setLogUnit
end submodule MOM_cap_mod_s
