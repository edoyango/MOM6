...
public :: real_to_time, time_minus_signed, time_to_real
  ...
  interface
type(time_type) module function real_to_time(time_in, err_msg, unscale)
...
real module function time_to_real(time, scale)
...
real module function time_minus_signed(time_a, time_b, scale)
