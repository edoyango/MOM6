...
interface CT_write_chksums
  ...
  interface
module function atmos_ocn_coupler_flux(name, flux_type, implementation, param, mol_wt, &
...
module subroutine CT_spawn_1d_2d(var_in, var, idim, jdim, suffix, as_needed)
...
module subroutine CT_spawn_1d_3d(var_in, var, idim, jdim, kdim, suffix, as_needed)
  type(coupler_1d_bc_type), intent(in)    :: var_in  !< structure from which to copy information
...
module subroutine CT_spawn_2d_2d(var_in, var, idim, jdim, suffix, as_needed)
...
module subroutine CT_spawn_2d_3d(var_in, var, idim, jdim, kdim, suffix, as_needed)
  type(coupler_2d_bc_type), intent(in)    :: var_in  !< structure from which to copy information
  type(coupler_3d_bc_type), intent(inout) :: var     !< structure into which to copy information
  integer, dimension(4),    intent(in)    :: idim    !< The data and computational domain extents of
                                                     !! the first dimension in a non-decreasing list
...
module subroutine CT_spawn_3d_2d(var_in, var, idim, jdim, suffix, as_needed)
...
module subroutine CT_spawn_3d_3d(var_in, var, idim, jdim, kdim, suffix, as_needed)
  type(coupler_3d_bc_type), intent(in)    :: var_in  !< structure from which to copy information
  type(coupler_3d_bc_type), intent(inout) :: var     !< structure into which to copy information
  integer, dimension(4),    intent(in)    :: idim    !< The data and computational domain extents of
                                                     !! the first dimension in a non-decreasing list
...
module subroutine CT_copy_data_2d(var_in, var, halo_size, bc_index, field_index, &
...
module subroutine CT_copy_data_3d(var_in, var, halo_size, bc_index, field_index, &
                  exclude_flux_type, only_flux_type, pass_through_ice)
...
module subroutine CT_copy_data_2d_3d(var_in, var, halo_size, bc_index, field_index, &
...
module subroutine CT_increment_data_2d(var_in, var, halo_size, scale_factor, scale_prev)
...
module subroutine CT_increment_data_3d(var_in, var, halo_size, scale_factor, scale_prev, exclude_flux_type, only_flux_type)
...
module subroutine CT_rescale_data_2d(var, scale)
...
module subroutine CT_rescale_data_3d(var, scale)
...
module subroutine CT_increment_data_2d_3d(var_in, weights, var, halo_size)
  type(coupler_3d_bc_type),   intent(in)    :: var_in  !< coupler_type structure with the data to add to the other type
...
module subroutine CT_redistribute_data_2d(var_in, domain_in, var_out, domain_out, complete)
  type(coupler_2d_bc_type), intent(in)    :: var_in     !< BC_type structure with the data to copy
...
module subroutine CT_redistribute_data_3d(var_in, domain_in, var_out, domain_out, complete)
  type(coupler_3d_bc_type), intent(in)    :: var_in     !< BC_type structure with the data to copy
  type(domain2D),           intent(in)    :: domain_in  !< The FMS domain for the input structure
...
module subroutine CT_extract_data(var_in, bc_index, field_index, array_out, &
...
module subroutine CT_set_data(array_in, bc_index, field_index, var, &
                       scale_factor, halo_size, idim, jdim)
...
module subroutine CT_data_override(gridname, var, time)
...
module subroutine CT_set_diags(var, diag_name, axes, time)
...
module subroutine CT_write_chksums_3d(var, outunit, name_lead)
