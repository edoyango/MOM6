...
interface impose_data
  ...
  interface
module subroutine impose_data_init(MOM_domain_in, Ocean_domain_in, Ice_domain_in)
...
module subroutine data_override_MD(domain, fieldname, data_2D, time, scale, override, is_ice)
...
module subroutine data_override_2d(gridname, fieldname, data_2D, time, override)
...
module subroutine impose_data_unset_domains(unset_Ocean, unset_Ice, must_be_set)
